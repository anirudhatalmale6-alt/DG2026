                    ...
                    <tr>
                        <td class="x-left">
                            <div class="x-logo">
                                @if(request('view') == 'preview')
                                <img
                                    src="{{ url('/storage/logos/app/'.config('system.settings_system_logo_large_name')) }}">
                                @else

                                <!--Fix Nov 2025: newer version of Imagick cause file not found errors. Using raw base64-->
                                @php
                                $logoPath = BASE_DIR.'/storage/logos/app/' .
                                config('system.settings_system_logo_large_name');
                                $logoData = base64_encode(file_get_contents($logoPath));
                                $logoSrc = 'data:image/png;base64,' . $logoData;
                                @endphp
                                <img src="{{ $logoSrc }}" style="max-width: 200px; height: auto;">
                                @endif
                            </div>
                        </td>
                        <td class="x-right">
                            <div class="x-bill-type">
                                ...
                                <span class="js-invoice-statuses">
                                    <h2
                                        class="text-uppercase text-{{ runtimeInvoiceStatusColors($bill->bill_status, 'text') }}">
                                        {{ runtimeInvoiceStatusTitle($bill->bill_status) }}</h2>
                                </span>
                            </div>
                            <div class="x-bill-type">
