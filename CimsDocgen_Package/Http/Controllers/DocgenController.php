...
namespace Modules\CimsDocgen\Http\Controllers;
...
use Modules\CimsDocgen\Models\DocgenTemplate;
use Modules\CimsDocgen\Models\DocgenTemplatePage;
use Modules\CimsDocgen\Models\DocgenFieldMapping;
use Modules\CimsDocgen\Models\DocgenDocument;
use Modules\CimsDocgen\Models\DocgenAuditLog;
use Modules\CimsDocgen\Models\DocgenSetting;
use Modules\CimsDocgen\Services\PdfGeneratorService;
...
class DocgenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cimsdocgen::documents.index', compact('documents', 'templates'));
    }
    ...
    public function show($id)
    {
        ...
        return view('cimsdocgen::documents.show', compact('document'));
    }
    ...
    public function create()
    {
        ...
        return view('cimsdocgen::documents.create', compact('templates'));
    }
    ...
    public function templates(Request $request)
    {
        ...
        return view('cimsdocgen::templates.index', compact('templates'));
    }

    public function templateCreate()
    {
        return view('cimsdocgen::templates.create');
    }
    ...
    public function templateEdit($id)
    {
        ...
        return view('cimsdocgen::templates.edit', compact('template', 'clientFields'));
    }
    ...
    public function fields($id)
    {
        ...
        return view('cimsdocgen::templates.fields', compact('page', 'clientFields'));
    }
    ...
    public function settings()
    {
        ...
        return view('cimsdocgen::settings.general', compact('settings'));
    }
    ...
    public function smtp()
    {
        ...
        return view('cimsdocgen::settings.smtp', compact('settings'));
    }
