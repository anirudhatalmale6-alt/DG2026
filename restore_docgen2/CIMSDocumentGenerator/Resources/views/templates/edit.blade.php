                ...
                <div class="card-body">
                    <form method="POST"
                        ...
                        <div class="row g-3 align-items-end">
                            {{-- PDF File Upload --}}
                            <div class="col-md-5">
                                <label for="pdfFileInput" class="form-label tpl-label">
                                ...
                                <input type="file"
                                       ...
                                       class="form-control"
                                       required>
                                <div class="form-text" style="font-size: 0.72rem;">PDF files only, max 10MB</div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ─── Auto-dismiss success messages only (errors stay visible) ─────
    ...
    function showToast(type, message) {
        ...
        // Auto-remove only success toasts after 5 seconds; error toasts stay visible
        if (type === 'success') {
            setTimeout(function() {
