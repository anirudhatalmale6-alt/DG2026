...
@push('styles')
<style>
/* Templates Index - Teal Theme */
.docgen-tpl-header {
    background: linear-gradient(135deg, #f8fdfe 0%, #eaf7f9 100%) !important;
    border-bottom: 2px solid #17A2B8 !important;
}
.docgen-tpl-header .card-title {
    color: #0d3d56;
    font-weight: 700;
}
.docgen-tpl-header .card-title i {
    color: #17A2B8;
}
.btn-docgen-teal {
    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex justify-content-between align-items-center docgen-tpl-header">
                    <h4 class="card-title mb-0">
                        <i class="fa fa-layer-group me-2"></i> Document Templates
                    </h4>
                    <div class="d-flex gap-2 align-items-center">
                        <a href="{{ route('cimsdocgen.templates.create') }}" class="btn btn-docgen-teal btn-sm shadow-sm">
                    ...
                    <form method="GET" action="{{ route('cimsdocgen.templates') }}" id="searchForm">
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col-md-3 col-lg-2">
                                @php
                                    $categories = $categories ?? \Modules\CIMSDocumentGenerator\Models\FormTemplateCategory::active()->orderBy('sort_order')->get();
                                @endphp
                            ...
                            <div class="col-md-4 col-lg-3 d-flex gap-2">
                                <button type="submit" class="btn btn-sm btn-docgen-teal">
