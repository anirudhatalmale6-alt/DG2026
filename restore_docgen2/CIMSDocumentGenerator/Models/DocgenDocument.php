...
class DocgenDocument extends Model
{
    ...
    protected $fillable = [
        'template_id', 'client_id', 'client_code', 'client_name', 'period_id',
        'document_name', 'document_number', 'file_path', 'file_name', 'file_size',
        'requested_by', 'prepared_by', 'approved_by', 'signed_by', 'witness_1', 'witness_2',
    ...
    {
        return $this->belongsTo(\Modules\CIMSDocumentGenerator\Models\CimsPeriod::class, 'period_id');
    }
