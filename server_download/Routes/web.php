...
Route::get('system-settings', [ClientMasterController::class, 'systemSettings'])->name('system.settings');
...
// Client Capture Form
Route::get('capture-form', [ClientMasterController::class, 'captureForm'])->name('client.capture-form');
Route::get('capture-form/blank-pdf', [ClientMasterController::class, 'captureFormBlankPdf'])->name('client.capture-form-blank-pdf');
Route::get('capture-form/completed-pdf', [ClientMasterController::class, 'captureFormCompletedPdf'])->name('client.capture-form-completed-pdf');
