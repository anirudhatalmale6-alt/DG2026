...
<div class="pp-control-bar">
    ...
    <div>
        ...
        <select id="ppPeriodSelect" onchange="ppOnPeriodChange()" disabled>
            <option value="">-- Select --</option>
        </select>
    </div>
    <div>
...
<div class="pp-container">
    ...
    <div class="pp-main">
        ...
        <div id="ppEmployeeContent" style="display:none; flex:1; flex-direction:column; overflow:hidden;">
            <!-- Employee Header -->
...
function ppOnPeriodChange() {
    ...
    // Update period display on the right
    ...
    if (display && ppSelectedPeriod && ppSelectedTaxYear) {
        ...
        const periodLabel = selectedOpt ? selectedOpt.text : '';
        const yr = parseInt(ppSelectedTaxYear);
        display.innerHTML = '<strong><i class="fas fa-calendar-alt"></i> ' + periodLabel + '</strong><span>Tax Year: ' + (yr - 1) + '/' + yr + '</span>';
    }
}
