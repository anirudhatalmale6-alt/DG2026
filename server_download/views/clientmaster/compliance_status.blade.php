    ...
    <div class="tcs-results-panel">
        ...
        <div class="tcs-results-body">
            ...
            <div class="tcs-accordion">
                <div class="tcs-accordion-header" data-bs-toggle="collapse" data-bs-target="#tcsRegistration" aria-expanded="true">
            ...
            {{-- ═══════════════════════════════════ --}}
            <div class="tcs-accordion">
                <div class="tcs-accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#tcsSubmissions" aria-expanded="false">
                    <div class="tcs-accordion-title">
                        <i class="fas fa-plus-circle"></i>
                        <i class="fas fa-minus-circle"></i>
            ...
            {{-- ═══════════════════════════════════ --}}
            <div class="tcs-accordion">
                <div class="tcs-accordion-header collapsed" data-bs-toggle="collapse" data-bs-target="#tcsDebt" aria-expanded="false">
                    <div class="tcs-accordion-title">
                        <i class="fas fa-plus-circle"></i>
                        <i class="fas fa-minus-circle"></i>
                        Debt
...
$(document).ready(function() {
    ...
    // Toggle +/- icons via BS5 collapse events
    document.querySelectorAll('.tcs-accordion .collapse').forEach(function(collapseEl) {
