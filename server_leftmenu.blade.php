        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
               ...
               <!--projects-->
                ...
                @stack('menu_main_team_22')
                <!--SmartDash-->
                <li data-modular-id="main_menu_smartdash"
                    class="sidenav-menu-item menu-tooltip menu-with-tooltip"
                    title="SmartDash">
                    <a class="waves-effect waves-dark p-r-20" href="/cims/welcome" aria-expanded="false" target="_self">
                        <i class="sl-icon-rocket"></i>
                        <span class="hide-menu">SmartDash
                        </span>
                    </a>
                </li>
