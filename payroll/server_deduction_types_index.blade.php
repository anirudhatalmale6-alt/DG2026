                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('cimspayroll.deduction-types.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2"><div class="mb-3"><label class="form-label">Calc Type</label><select name="calc_type" class="sd_drop_class"><option value="fixed">Fixed</option><option value="percentage">Percentage</option></select></div></div>
                            ...
                            <div class="col-md-1"><div class="mb-3"><label class="form-label">Statutory</label><select name="is_statutory" class="sd_drop_class"><option value="0">No</option><option value="1">Yes</option></select></div></div>
                            <div class="col-md-1"><div class="mb-3"><label class="form-label">Auto Calc</label><select name="is_auto_calculated" class="sd_drop_class"><option value="0">No</option><option value="1">Yes</option></select></div></div>
                        ...
                        <table class="table deduction-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="view-row" id="view-{{ $type->id }}">
                                    ...
                                    <td class="cims_money_format"><span class="deduction-type-calc">{{ $type->calc_type === 'percentage' ? number_format($type->default_value, 2) . '%' : cims_money_format($type->default_value) }}</span></td>
                                    ...
                                    <td colspan="10" style="padding:12px;background:#f0faff;">
                                        <form method="POST" action="{{ route('cimspayroll.deduction-types.update', $type->id) }}">
                                            ...
                                            <div class="edit-flex-row">
                                                ...
                                                <div class="edit-field" style="flex:1;"><label>Calc Type</label><select name="calc_type" class="form-control"><option value="fixed" {{ $type->calc_type==='fixed' ? 'selected' : '' }}>Fixed</option><option value="percentage" {{ $type->calc_type==='percentage' ? 'selected' : '' }}>Percentage</option></select></div>
                                                ...
                                                <div class="edit-field" style="flex:0.8;"><label>Statutory</label><select name="is_statutory" class="form-control"><option value="0" {{ !$type->is_statutory ? 'selected' : '' }}>No</option><option value="1" {{ $type->is_statutory ? 'selected' : '' }}>Yes</option></select></div>
                                                <div class="edit-field" style="flex:0.8;"><label>Auto Calc</label><select name="is_auto_calculated" class="form-control"><option value="0" {{ !$type->is_auto_calculated ? 'selected' : '' }}>No</option><option value="1" {{ $type->is_auto_calculated ? 'selected' : '' }}>Yes</option></select></div>
                                            ...
                                            <div class="edit-flex-row" style="align-items:flex-end;">
                                                <div class="edit-field" style="flex:3;"><label>Description</label><input type="text" name="description" value="{{ $type->description }}" class="form-control"></div>
