            ...
            <li class="cims-menu-item">
                ...
                <ul class="cims-submenu">
                    ...
                    <li>
                        ...
                        <ul class="cims-submenu-level3">
                            <li><a href="/cims/payroll/timesheets">Timesheets</a></li>
                            <li><a href="/cims/payroll/leave-types">Leave Types</a></li>
                            <li><a href="/cims/payroll/leave/balances">Leave Balances</a></li>
                            <li><a href="/cims/payroll/leave/applications">Leave Applications</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="cims-submenu-level3">
                            <li><a href="/cims/payroll/pay-runs">Pay Runs</a></li>
                            <li><a href="/cims/payroll/loans">Loans Register</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="/cims/payroll/payslips"><i class="fas fa-file-invoice-dollar"></i> Payslips</a>
                    ...
                    <li>
                        ...
                        <ul class="cims-submenu-level3">
                            <li><a href="/cims/payroll/reports/payroll-summary">Payroll Summary</a></li>
                            <li><a href="/cims/payroll/reports/paye">PAYE Report</a></li>
                            <li><a href="/cims/payroll/reports/uif">UIF Report</a></li>
                            <li><a href="#">EMP201</a></li>
                            <li><a href="#">EMP501 / IRP5</a></li>
                            <li><a href="/cims/payroll/reports/leave">Leave Report</a></li>
                            <li><a href="/cims/payroll/reports/loans">Loan Report</a></li>
                            <li><a href="/cims/payroll/reports/cost-to-company">Cost to Company</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
