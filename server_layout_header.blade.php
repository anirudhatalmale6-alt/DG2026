<head>
    ...
    <link rel="stylesheet"
        href="/public/vendor/fonts/phosphor-icons/regular/style.css?v={{ config('system.versioning') }}">

    <!--2025 - TABLER ICONS-->
    <link rel="stylesheet"
        href="/public/vendor/fonts/tabler-icons/tabler-icons.css?v={{ config('system.versioning') }}">

    <!--2025 - LINEICONS ICONS-->
    <link rel="stylesheet" href="/public/vendor/fonts/lineicons/css/icons.css?v={{ config('system.versioning') }}">
    ...
    <script type="text/javascript">
        ...
        NXLANG.invoice_mode = "{{ cleanLang(__('lang.invoice_mode')) }}";
        NXLANG.url_copied_to_clipboard = "{{ cleanLang(__('lang.url_copied_to_clipboard')) }}";
        NXLANG.copied = "{{ cleanLang(__('lang.copied')) }}";
