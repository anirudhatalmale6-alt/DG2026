...
<div class="container-fluid">
    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                ...
                <p class="mb-0">Create a new job card</p>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-9 col-lg-8">
            ...
            <form action="{{ route('cimstyredash.jobcards.store') }}" method="POST" id="jobCardForm">
                @csrf
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3 col-sm-6">
                                ...
                                <input type="text" class="form-control" id="job_card_number" name="job_card_number" value="{{ $jobCardNumber }}" readonly>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <label class="form-label" for="job_date">Date</label>
                                <input type="date" class="form-control @error('job_date') is-invalid @enderror" id="job_date" name="job_date" value="{{ old('job_date', date('Y-m-d')) }}" required>
                                @error('job_date')
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <input type="text" class="form-control @error('technician_name') is-invalid @enderror" id="technician_name" name="technician_name" value="{{ old('technician_name') }}" placeholder="Enter technician name">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" id="customer_search" placeholder="Type customer name, phone or email..." autocomplete="off">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control" id="vehicle_search" placeholder="Type registration, make or model..." autocomplete="off">
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control @error('odometer_in') is-invalid @enderror" id="odometer_in" name="odometer_in" value="{{ old('odometer_in') }}" min="0" placeholder="e.g. 45000">
                                @error('odometer_in')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('vehicle_condition_notes') is-invalid @enderror" name="vehicle_condition_notes" rows="3" placeholder="Describe the condition of the vehicle upon arrival...">{{ old('vehicle_condition_notes') }}</textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="tyreContainer">
                        {{-- Dynamic tyre lines inserted here --}}
                    </div>
                    <div class="card-footer text-muted text-center" id="noTyresMsg">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body" id="serviceContainer">
                        {{-- Dynamic service lines inserted here --}}
                    </div>
                    <div class="card-footer text-muted text-center" id="noServicesMsg">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control @error('work_notes') is-invalid @enderror" name="work_notes" rows="3" placeholder="Additional work notes or instructions...">{{ old('work_notes') }}</textarea>
                        @error('work_notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function buildProductOptions() {
        ...
        products.forEach(function(p) {
            ...
            html += '<option value="' + p.id + '" data-price="' + (p.selling_price || 0) + '">' + escapeHtml(label.trim()) + '</option>';
        });
        return html;
    }
        ...
        row.innerHTML =
            '<div class="row g-2 align-items-end">' +
                ...
                '<div class="col-md-1">' +
                    ...
                    '<input type="number" class="form-control form-control-sm" name="tyres[' + idx + '][quantity]" value="1" min="1" required>' +
                '</div>' +
                '<div class="col-md-2">' +
                ...
                '<div class="col-md-2">' +
                    ...
                    '<input type="number" class="form-control form-control-sm tyre-unit-price" name="tyres[' + idx + '][unit_price]" step="0.01" min="0" value="0.00" required>' +
                '</div>' +
                '<div class="col-md-2">' +
                    '<label class="form-label small">Serial New</label>' +
                    '<input type="text" class="form-control form-control-sm" name="tyres[' + idx + '][serial_new]" placeholder="Optional">' +
                '</div>' +
                '<div class="col-md-2 d-flex align-items-end">' +
                    '<div class="flex-grow-1 me-2">' +
                        '<label class="form-label small">Serial Old</label>' +
                        '<input type="text" class="form-control form-control-sm" name="tyres[' + idx + '][serial_old]" placeholder="Optional">' +
                    '</div>' +
    ...
    function buildServiceOptions() {
        ...
        services.forEach(function(s) {
            ...
            html += '<option value="' + s.id + '" data-price="' + (s.price || 0) + '">' + escapeHtml(label) + '</option>';
        });
        return html;
    }
    ...
    document.getElementById('addServiceLine').addEventListener('click', function() {
        ...
        row.innerHTML =
            '<div class="row g-2 align-items-end">' +
                ...
                '<div class="col-md-2">' +
                    '<label class="form-label small">Qty</label>' +
                    '<input type="number" class="form-control form-control-sm" name="services[' + idx + '][quantity]" value="1" min="1" required>' +
                '</div>' +
                '<div class="col-md-3">' +
                    '<label class="form-label small">Unit Price</label>' +
                    '<input type="number" class="form-control form-control-sm service-unit-price" name="services[' + idx + '][unit_price]" step="0.01" min="0" value="0.00" required>' +
                '</div>' +
