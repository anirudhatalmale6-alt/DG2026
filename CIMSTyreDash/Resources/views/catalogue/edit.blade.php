            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <i class="fas fa-edit me-2"></i>Edit Product: {{ $product->product_code }}
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('cimstyredash.catalogue.update', $product->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="model_name" id="model_name" class="form-control @error('model_name') is-invalid @enderror" value="{{ old('model_name', $product->model_name) }}" placeholder="e.g. Pilot Sport 5">
                                @error('model_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="product_code" id="product_code" class="form-control @error('product_code') is-invalid @enderror" value="{{ old('product_code', $product->product_code) }}" placeholder="e.g. MICH-PS5-2554018">
                                @error('product_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="full_description" id="full_description" class="form-control @error('full_description') is-invalid @enderror" rows="3" placeholder="Detailed product description...">{{ old('full_description', $product->full_description) }}</textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="load_index" id="load_index" class="form-control @error('load_index') is-invalid @enderror" value="{{ old('load_index', $product->load_index) }}" placeholder="e.g. 98">
                                @error('load_index')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="speed_rating" id="speed_rating" class="form-control @error('speed_rating') is-invalid @enderror" value="{{ old('speed_rating', $product->speed_rating) }}" placeholder="e.g. Y">
                                @error('speed_rating')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="pattern_type" id="pattern_type" class="form-control @error('pattern_type') is-invalid @enderror" value="{{ old('pattern_type', $product->pattern_type) }}" placeholder="e.g. Asymmetric">
                                @error('pattern_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="cost_price" id="cost_price" class="form-control @error('cost_price') is-invalid @enderror" value="{{ old('cost_price', $product->cost_price) }}" step="0.01" min="0" placeholder="0.00">
                                    @error('cost_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">R</span>
                                    <input type="number" name="sell_price" id="sell_price" class="form-control @error('sell_price') is-invalid @enderror" value="{{ old('sell_price', $product->sell_price) }}" step="0.01" min="0" placeholder="0.00">
                                    @error('sell_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="markup_pct" id="markup_pct" class="form-control @error('markup_pct') is-invalid @enderror" value="{{ old('markup_pct', $product->markup_pct) }}" step="0.1" min="0" placeholder="0.0">
