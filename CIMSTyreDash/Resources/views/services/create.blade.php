        ...
        <div class="col-xl-9 col-lg-8">
            ...
            <div class="card form-card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cimstyredash.services.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{ old('code') }}" maxlength="20" required>
                                    @error('code')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="price_per_tyre" id="price_per_tyre" value="1" {{ old('price_per_tyre') ? 'checked' : '' }}>
