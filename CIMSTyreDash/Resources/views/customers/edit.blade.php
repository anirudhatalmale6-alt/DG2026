        ...
        <div class="col-xl-9 col-lg-8">
            ...
            <div class="card form-card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('cimstyredash.customers.update', $customer->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('cell') is-invalid @enderror" id="cell" name="cell" value="{{ old('cell', $customer->cell) }}">
                                    @error('cell')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('debtor_account') is-invalid @enderror" id="debtor_account" name="debtor_account" value="{{ old('debtor_account', $customer->debtor_account) }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('vat_number') is-invalid @enderror" id="vat_number" name="vat_number" value="{{ old('vat_number', $customer->vat_number) }}">
                                    @error('vat_number')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('cimstyredash.customers.show', $customer->id) }}" class="btn btn-outline-secondary ms-2">
