    ...
    <div class="cims-header-inner">
        ...
        <div class="cims-header-left">
            <div class="cims-header-brand">
                <img src="{{ asset('images/atp_cims_logo.jpg') }}" alt="Sunshine CIMS" class="cims-header-logo">
                <span class="cims-header-separator"></span>
                <span class="cims-header-brand-name">Sunshine - CIMS 3000</span>
            </div>
        </div>
        ...
        <div class="cims-header-right">
            ...
            <div class="cims-header-profile">
                <img src="{{ asset('images/user_profile.jpg') }}" alt="User" class="cims-profile-img">
            </div>
        </div>
