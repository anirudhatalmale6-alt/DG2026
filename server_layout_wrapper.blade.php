<!DOCTYPE html>
<html lang="en" class="{{ auth()->user()->type ?? '' }} {{ config('visibility.page_rendering') }} {{ config('active_theme') }}" data-bs-theme="{{ config('active_theme') }}">

<!--CRM - GROWCRM.IO-->
@include('layout.header')

<body id="main-body" data-main-menu-id="{{ $page['main_menu_id'] ?? '' }}" data-sub-menu-id="{{ $page['sub_menu_id'] ?? '' }}"
