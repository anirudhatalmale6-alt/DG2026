    ...
    <div class="cims-nav-container">
        <ul class="cims-main-menu">
            ...
            {{-- ============================================================
                 ...
                 ============================================================ --}}
            <li class="cims-menu-item" style="display:none">
            ...
            <li class="cims-menu-item">
                ...
                <ul class="cims-submenu">
                    ...
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-users-gear"></i> Client Tools</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Client info sheets & capture forms</div>
                        <ul class="cims-submenu-level3">
                            ...
                            <li><a href="{{ Route::has('client.capture-form') ? route('client.capture-form') : '#' }}"><i class="fas fa-file-pen"></i> Client Capture Form</a></li>
                        </ul>
                    </li>
                    <li>
            ...
            {{-- ============================================================
                 MASTERS - Main Menu Item (Top Level)
                 ============================================================ --}}
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            {{-- ============================================================
                 SALES - Main Menu Item (GrowCRM Sales Module)
                 ============================================================ --}}
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Invoices, payments, estimates, subscriptions</div>
                <ul class="cims-submenu">
                    <li>
                    ...
                    <li>
                        <a href="/aged-analysis"><i class="fas fa-chart-bar"></i> Aged Analysis</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Customer aged analysis report</div>
                    </li>
                </ul>
            </li>
            ...
            <li class="cims-menu-item">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Job card workflow management</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="/job-cards/dashboard"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Job card overview and statistics</div>
                    </li>
                    <li>
                        <a href="/job-cards"><i class="fas fa-list"></i> All Job Cards</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">View and manage all job cards</div>
                    </li>
                    <li>
                        <a href="/job-cards/create"><i class="fas fa-plus-circle"></i> New Job Card</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Create a new job card</div>
                    </li>
                    <li>
                        <a href="/job-cards/admin/types"><i class="fas fa-cog"></i> Setup</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Configure job types, steps, fields</div>
                    </li>
                </ul>
            </li>
            ...
            {{-- ============================================================
                 PAYROLL - Main Menu Item 5 (HIDDEN)
                 ============================================================ --}}
            <li class="cims-menu-item" style="display:none">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            <li class="cims-menu-item">
                ...
                <ul class="cims-submenu">
                    ...
                    <li>
                        <a href="{{ Route::has('system.settings') ? route('system.settings') : '#' }}"><i class="fas fa-cogs"></i> System Settings</a>
...
<style>
/*
 * CIMS MASTER MENU - ENHANCED STYLES
 * -----------------------------------
 * All styles scoped to .cims-menu-wrapper to avoid conflicts
 *
 * COLOR REFERENCE:
...
/* ---- KEYFRAME ANIMATIONS ---- */
@keyframes cims_slideDown {
    from { opacity: 0; transform: translateY(-12px); }
    to { opacity: 1; transform: translateY(0); }
}
@keyframes cims_slideRight {
    from { opacity: 0; transform: translateX(-12px); }
    to { opacity: 1; transform: translateX(0); }
}
@keyframes cims_slideLeft {
    from { opacity: 0; transform: translateX(12px); }
    to { opacity: 1; transform: translateX(0); }
}
...
/* ---- MAIN NAV BAR ---- */
.cims-nav-container {
    background: linear-gradient(to right, #0d3d56 0%, #145a6e 40%, #17A2B8 100%);
    width: 100%;
    padding: 0;
    position: relative;
    z-index: 1000;
    box-shadow: 0 4px 20px rgba(13, 61, 86, 0.35), 0 1px 0 rgba(32, 201, 151, 0.2) inset;
}

/* ---- MAIN MENU (horizontal flex) ---- */
.cims-main-menu {
    display: flex;
    flex-direction: row;
    flex-wrap: nowrap;
...
.cims-menu-link:hover::after,
.cims-menu-item:hover > .cims-menu-link::after {
    width: 80%;
}
...
.cims-menu-item:hover > .cims-menu-link i {
    ...
    text-shadow: 0 0 12px rgba(32, 201, 151, 0.6);
}
...
.cims-submenu {
    ...
    top: 100%;
    left: 0;
    background: linear-gradient(180deg, #ffffff 0%, #f4fbfc 40%, #e8f6f8 100%);
    width: auto;
    ...
    padding: 10px 0;
    box-shadow:
        0 12px 40px rgba(13, 61, 86, 0.18),
        0 4px 12px rgba(23, 162, 184, 0.12),
...
.cims-menu-item:hover > .cims-submenu {
    display: block;
    animation: cims_slideDown 0.3s cubic-bezier(0.4, 0, 0.2, 1);
}
...
.cims-submenu > li > a:hover {
    background: linear-gradient(90deg, rgba(23, 162, 184, 0.12) 0%, rgba(32, 201, 151, 0.06) 100%);
    color: #0d3d56;
...
.cims-submenu > li + li > a {
    border-top: 1px solid rgba(23, 162, 184, 0.08);
}
...
/* Show level 3 on hover WITH animation */
.cims-submenu > li:hover > .cims-submenu-level3 {
    display: block;
    animation: cims_slideRight 0.3s cubic-bezier(0.4, 0, 0.2, 1);
}
...
/* Level 3 hover - teal gradient with rounded edge */
.cims-submenu-level3 > li > a:hover {
    ...
    box-shadow: 0 2px 8px rgba(13, 61, 86, 0.2);
}

/* Flip level 3 to left when near right edge */
...
/* Animate flip-left from right */
.cims-submenu > li:hover > .cims-submenu-level3.flip-left {
    animation: cims_slideLeft 0.3s cubic-bezier(0.4, 0, 0.2, 1);
}
