<!DOCTYPE html>
<html lang="en" class="logged-out <?php echo e(config('visibility.page_rendering')); ?> <?php echo e(config('active_theme')); ?>" data-bs-theme="<?php echo e(config('active_theme')); ?>">
...
</html><?php /**PATH /usr/www/users/smartucbmh/application/resources/views/layout/wrapperplain.blade.php ENDPATH**/ ?>