    ...
    <div class="cims-footer-inner">
        ...
        <div class="cims-footer-left">
            <span class="cims-copyright">
                &copy; <?php echo e(date('Y')); ?> <strong>Footer - Sunshine</strong> â All Rights Reserved
            </span>
        ...
        <div class="cims-footer-center">
            <a href="https://smartweigh.co.za/home" class="cims-footer-link cims-grow-crm"><i class="fas fa-arrow-left"></i> Grow CRM</a>
            ...
            <span class="cims-footer-dot"></span>
            <a href="#" class="cims-footer-link cims-clear-cache" id="clearCacheBtnMaster" title="Clear application cache">
...
(function() {
    document.addEventListener('DOMContentLoaded', function() {
        var clearCacheBtn = document.getElementById('clearCacheBtnMaster');
        if (clearCacheBtn) {
            clearCacheBtn.addEventListener('click', function(e) {
                ...
                fetch(`<?php echo e(Route::has('clear.cache') ? route('clear.cache') : '/public/clear_cache.php'); ?>`, {
                    method: 'GET',
                    headers: {
...
<?php /**PATH /usr/www/users/smartucbmh/application/Modules/CIMSCore/Resources/views/partials/cims_master_footer.blade.php ENDPATH**/ ?>