                ...
                <div class="card-body">
                    <div class="file-preview-box">
                        ...
                        <div class="d-flex flex-column gap-2 mt-2">
                            <a href="{{ route('cimsdocmanager.download',$document->id)}}" class="btn btn-pink cims-download-button">
                                <i class="fa-solid fa-download"></i> Download
                            </a>
                            <a href="{{ route('cimsemail.compose', ['client_id' => $document->client_id, 'template_name' => 'Document Requested', 'attach_document_id' => $document->id]) }}" class="btn btn-pink cims-email-button">
