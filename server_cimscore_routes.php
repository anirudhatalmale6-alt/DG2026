...
// Clear Cache - clears all server-side caches and forces browser refresh
Route::get('/cims/clear-cache', [WelcomeController::class, 'clearCache'])->name('cimscore.clear-cache');
