...
class DocgenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cimsdocumentgenerator::documents.index', compact('documents', 'templates'));
    }
    ...
    public function create()
    {
        ...
        return view('cimsdocumentgenerator::documents.create', compact('templates'));
    }
    ...
    public function pageStore(Request $request, $id)
    {
        ...
        // Verify it's a PDF by checking extension or MIME
