...
<style>
/* Page-specific styles - inherits from smartdash-forms.css */
...
.image-title-btn {
    margin: 2px;
    background: linear-gradient(135deg, var(--sd-primary, #17A2B8) 0%, var(--sd-primary-dark, #0d3d56) 100%);
    border: none;
    font-size: var(--sd-font-size-sm, 13px);
    padding: var(--sd-spacing-sm, 8px) var(--sd-spacing-md, 12px);
    border-radius: var(--sd-border-radius, 8px);
}

.image-title-btn:hover {
    background: linear-gradient(135deg, var(--sd-primary-dark, #0d3d56) 0%, var(--sd-primary, #17A2B8) 100%);
}

/* Signature placeholder */
.signature-placeholder {
    border: 2px dashed var(--sd-primary, #17A2B8);
    padding: 30px;
    text-align: center;
    margin-top: var(--sd-spacing-md, 12px);
    border-radius: var(--sd-border-radius, 8px);
    background: #f8f9fa;
}

.signature-placeholder p {
    color: var(--sd-primary-dark, #0d3d56);
    font-weight: var(--sd-font-weight-semibold, 600);
    font-size: var(--sd-font-size-lg, 16px);
    margin: 0;
}
...
.photo-pill-btn:hover {
    background: linear-gradient(135deg, #0d6b7a 0%, #17A2B8 100%);
    color: #fff;
