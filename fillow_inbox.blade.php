                            ...
                            <div class="col-xl-3">
                                <div class="email-left-body email-left-box ">
                                    <div class="mb-3 mt-4 mt-sm-0">
                                        <div class="p-0">
                                            <a href="javascript:void(0)" class="btn btn-primary btn-block">Compose</a>
                                        </div>
                                        ...
                                        <div class="mail-list rounded overflow-hidden">
                                            ...
                                            <a href="javascript:void(0)" class="list-group-item"><span class="icon-warning"><i
                                                        class="fa fa-circle" aria-hidden="true"></i></span>
                                                Work </a>
                                            <a href="javascript:void(0)" class="list-group-item"><span class="icon-primary"><i
                                                        class="fa fa-circle" aria-hidden="true"></i></span>
                                                Private </a>
                                            <a href="javascript:void(0)" class="list-group-item"><span class="icon-success"><i
                                                        class="fa fa-circle" aria-hidden="true"></i></span>
                                                Support </a>
                                            <a href="javascript:void(0)" class="list-group-item"><span class="icon-dpink"><i
                                                        class="fa fa-circle" aria-hidden="true"></i></span>
                                                Social </a>
                                        </div>
                                    </div>
                                    ...
                                    <div role="toolbar" class="toolbar ms-1 ms-sm-0 ms-xl-1 d-flex align-items-center">
                                        ...
                                        <form class=" d-none d-sm-block ms-auto">
                                            <div class="input-group  ms-auto w-100 d-sm-inline-flex d-none">
                                                ...
                                                <span class="input-group-text"><button class="bg-transparent border-0"><i
