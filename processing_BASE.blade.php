...
.pp-container { display: flex; height: calc(100vh - 240px); overflow: hidden; background: #f4f6f9; border-radius: 8px; border: 1px solid #e0e0e0; box-shadow: 0 2px 8px rgba(0,0,0,0.06); }

/* Control Bar — Breadcrumb White style */
.pp-control-bar {
    background: linear-gradient(135deg, #ffffff 0%, #f0fafb 100%);
    padding: 18px 24px; display: flex; align-items: flex-end; gap: 20px;
...
.pp-control-bar:hover { box-shadow: 0 6px 25px rgba(0, 0, 0, 0.12); }
.pp-control-bar .pp-ctrl-group { display: flex; flex-direction: column; gap: 4px; position: relative; }
.pp-control-bar .pp-ctrl-group label {
    font-size: 11px; font-weight: 700; color: #009688;
    text-transform: uppercase; letter-spacing: 0.5px; margin: 0;
}
.pp-control-bar select {
    padding: 8px 14px; border: 1px solid #B2DFDB; border-radius: 8px;
    font-size: 13px; font-family: 'Poppins', sans-serif; color: #333;
    background: #fff; transition: all 0.2s;
    box-shadow: 0 1px 4px rgba(0,0,0,0.06); appearance: auto;
}
.pp-control-bar select:focus {
    border-color: #009688; box-shadow: 0 0 0 3px rgba(0,150,136,0.12); outline: none;
}
.pp-control-bar select:disabled { background: #f5f5f5; color: #aaa; cursor: not-allowed; }

/* Bootstrap-Select Teal Theme for Control Bar */
.pp-control-bar .pp-ctrl-group .bootstrap-select { width: 100% !important; }
.pp-control-bar .bootstrap-select { min-width: 160px; }
.pp-control-bar .bootstrap-select > .dropdown-toggle {
    padding: 7px 14px !important; border: 1.5px solid #17a2b8 !important; border-radius: 6px;
    font-size: 15px !important; font-family: 'Poppins', sans-serif; color: #333;
    background: #fff !important; box-shadow: none;
    height: 38px !important; line-height: 1.5;
}
.pp-control-bar .bootstrap-select > .dropdown-toggle:focus,
.pp-control-bar .bootstrap-select.show > .dropdown-toggle {
    border-color: #009688 !important; box-shadow: 0 0 0 2px rgba(0,150,136,0.15) !important; outline: none !important;
}
.pp-control-bar .bootstrap-select .dropdown-toggle .filter-option-inner-inner {
    overflow: hidden; text-overflow: ellipsis; font-size: 15px;
}
.pp-control-bar .bootstrap-select .dropdown-menu {
    border: 1.5px solid #17a2b8; border-radius: 6px; box-shadow: 0 4px 16px rgba(0,0,0,0.10);
    padding: 0; overflow: hidden; margin-top: 2px;
}
.pp-control-bar .bootstrap-select .dropdown-menu .bs-searchbox {
    padding: 8px 10px; border-bottom: 1px solid #e0e0e0;
}
.pp-control-bar .bootstrap-select .dropdown-menu .bs-searchbox input {
    border: 1.5px solid #17a2b8; border-radius: 5px; font-size: 15px;
    padding: 6px 12px; font-family: 'Poppins', sans-serif; height: 36px;
}
.pp-control-bar .bootstrap-select .dropdown-menu .bs-searchbox input:focus {
    border-color: #009688; box-shadow: 0 0 0 2px rgba(0,150,136,0.15); outline: none;
}
.pp-control-bar .bootstrap-select .dropdown-menu li a,
.pp-control-bar .bootstrap-select .dropdown-menu li .dropdown-item {
    padding: 8px 14px; font-size: 15px; color: #333; border-bottom: 1px solid #e8e8e8;
    font-family: 'Poppins', sans-serif; transition: all 0.15s;
}
.pp-control-bar .bootstrap-select .dropdown-menu li:last-child a,
.pp-control-bar .bootstrap-select .dropdown-menu li:last-child .dropdown-item { border-bottom: none; }
.pp-control-bar .bootstrap-select .dropdown-menu li a:hover,
.pp-control-bar .bootstrap-select .dropdown-menu li .dropdown-item:hover {
    background: #E0F2F1; color: #004D40;
}
.pp-control-bar .bootstrap-select .dropdown-menu li.selected a,
.pp-control-bar .bootstrap-select .dropdown-menu li.active a,
.pp-control-bar .bootstrap-select .dropdown-menu li.selected .dropdown-item,
.pp-control-bar .bootstrap-select .dropdown-menu li.active .dropdown-item {
    background: #17a2b8 !important; color: #fff !important;
}
.pp-control-bar .bootstrap-select .dropdown-menu li.disabled a { color: #aaa; background: #f5f5f5; }
.pp-control-bar .bootstrap-select.disabled > .dropdown-toggle { background: #f5f5f5 !important; color: #aaa; cursor: not-allowed; opacity: 0.65; border-color: #ccc !important; }
.pp-load-btn {
    background: linear-gradient(135deg, #E91E63 0%, #C2185B 100%);
    border: none; color: #fff; padding: 7px 22px; border-radius: 6px; font-size: 15px;
    font-weight: 600; cursor: pointer; transition: all 0.2s; display: inline-flex;
    align-items: center; gap: 6px; white-space: nowrap; height: 38px;
    box-shadow: 0 3px 10px rgba(233, 30, 99, 0.3);
}
.pp-load-btn:hover { background: linear-gradient(135deg, #C2185B 0%, #AD1457 100%); box-shadow: 0 4px 15px rgba(233, 30, 99, 0.4); transform: translateY(-1px); }
.pp-load-btn:disabled { opacity: 0.4; cursor: not-allowed; transform: none; box-shadow: none; }
.pp-period-info { margin-left: auto; font-size: 12px; color: #0d3d56; text-align: right; }
.pp-period-info strong { font-size: 15px; display: block; color: #0d3d56; font-weight: 700; }
.pp-period-info span { color: #888; }
...
/* Main Content Area */
.pp-main { flex: 1; display: flex; flex-direction: column; overflow: hidden; min-height: 0; }
...
/* Tab Content */
.pp-tab-content { flex: 1; overflow-y: auto; padding: 20px; min-height: 0; }
    ...
    <div class="smartdash-page-header" style="margin-bottom: 20px;">
        <div class="page-title">
            ...
            <div>
                ...
                <p>Process employee payroll, generate payslips</p>
            </div>
        </div>
        <div class="page-breadcrumb">
            ...
            <span class="separator">/</span>
            <span class="current">Processing</span>
        </div>
    </div>

<!-- Control Bar -->
<div class="pp-control-bar">
    <div class="pp-ctrl-group" style="flex:2; min-width:350px;">
        <label><i class="fas fa-building"></i> Company</label>
        <select id="ppCompanySelect" class="selectpicker" data-live-search="true" data-width="100%" data-style="" data-size="8" title="— Select Company —" style="width:100%;">
    ...
    <div class="pp-ctrl-group">
        ...
        <select id="ppTaxYearSelect" class="selectpicker" data-width="100%" data-style="" data-size="8" title="— Select —" disabled style="min-width:160px;">
        </select>
    </div>
    <div class="pp-ctrl-group">
        <label><i class="fas fa-clock"></i> Pay Period</label>
        <select id="ppPeriodSelect" class="selectpicker" data-live-search="true" data-width="100%" data-style="" data-size="8" title="— Select —" disabled style="min-width:190px;">
        </select>
    </div>
    <div class="pp-ctrl-group" style="z-index: 3; justify-content: flex-end;">
        <button type="button" class="pp-load-btn" id="ppLoadBtn" onclick="ppLoadEmployees()" disabled>
            <i class="fas fa-users"></i> Load Employees
        </button>
    </div>
    <div class="pp-period-info" id="ppPeriodDisplay">
        <strong><i class="fas fa-calendar-alt"></i> {{ now()->format('F Y') }}</strong>
        <span>Tax Year: {{ now()->month >= 3 ? now()->year : now()->year - 1 }}/{{ now()->month >= 3 ? now()->year + 1 : now()->year }}</span>
    </div>
</div>
...
<div class="pp-container">
    ...
    <div class="pp-sidebar">
        ...
        <div class="pp-employee-list" id="ppEmployeeList">
            <div class="pp-empty" style="padding:30px 10px;">
                ...
                <p>Select a company to load employees</p>
            </div>
        </div>
    ...
    <div class="pp-main">
        ...
        <div id="ppEmployeeContent" style="display:none; flex:1; flex-direction:column; overflow:hidden; min-height:0;">
            <!-- Employee Header -->
...
function ppOnCompanyChange() {
    const companyId = $('#ppCompanySelect').val();
    const loadBtn = document.getElementById('ppLoadBtn');

    $('#ppPeriodSelect').html('').prop('disabled', true).selectpicker('refresh');
    loadBtn.disabled = true;

    if (!companyId) {
        $('#ppTaxYearSelect').html('').prop('disabled', true).selectpicker('refresh');
        return;
    }

    // Populate tax years
    const now = new Date();
    const currentTaxYear = now.getMonth() >= 2 ? now.getFullYear() + 1 : now.getFullYear();
    let html = '';
    for (let y = currentTaxYear + 1; y >= currentTaxYear - 2; y--) {
        const selected = y === currentTaxYear ? ' selected' : '';
        html += '<option value="' + y + '"' + selected + '>' + (y - 1) + ' / ' + y + '</option>';
    }
    $('#ppTaxYearSelect').html(html).prop('disabled', false).selectpicker('refresh');
    ppOnTaxYearChange();
}

function ppOnTaxYearChange() {
    const loadBtn = document.getElementById('ppLoadBtn');
    ppSelectedTaxYear = $('#ppTaxYearSelect').val();
    loadBtn.disabled = true;
    ...
    ppMonths.forEach(m => {
        ...
        if (m.value === (now.getMonth() + 1) && calYear === now.getFullYear()) preselect = val;
        html += '<option value="' + val + '">' + m.label + ' ' + calYear + '</option>';
    });

    $('#ppPeriodSelect').html(html).prop('disabled', false).selectpicker('refresh');
    if (preselect) $('#ppPeriodSelect').selectpicker('val', preselect);
    ppOnPeriodChange();
}

function ppOnPeriodChange() {
    const loadBtn = document.getElementById('ppLoadBtn');
    ppSelectedPeriod = $('#ppPeriodSelect').val();
    loadBtn.disabled = !(ppSelectedPeriod && $('#ppCompanySelect').val() && $('#ppTaxYearSelect').val());

    // Update period display
    const display = document.getElementById('ppPeriodDisplay');
    if (display && ppSelectedPeriod && ppSelectedTaxYear) {
        const pSel = document.getElementById('ppPeriodSelect');
        const selOpt = pSel.options[pSel.selectedIndex];
        const yr = parseInt(ppSelectedTaxYear);
        display.innerHTML = '<strong><i class="fas fa-calendar-alt"></i> ' + (selOpt ? selOpt.text : '') + '</strong><span>Tax Year: ' + (yr - 1) + '/' + yr + '</span>';
    }
}

// ─── COMPANY & EMPLOYEE LOADING ───
function ppLoadEmployees() {
    const companyId = document.getElementById('ppCompanySelect').value;
    if (!companyId) {
        document.getElementById('ppEmployeeList').innerHTML = '<div class="pp-empty" style="padding:30px 10px;"><i class="fas fa-building"></i><p>Select a company to load employees</p></div>';
    ...
    fetch('{{ url("cims/payroll/processing/employees") }}?company_id=' + companyId)
        .then(r => r.json())
        .then(data => {
...
// ─── INITIALIZE BOOTSTRAP-SELECT ON CONTROL BAR DROPDOWNS ───
$(function() {
    $('#ppCompanySelect, #ppTaxYearSelect, #ppPeriodSelect').selectpicker();
    // Bind change events through jQuery (bootstrap-select fires 'changed.bs.select')
    $('#ppCompanySelect').on('changed.bs.select', function() { ppOnCompanyChange(); });
    $('#ppTaxYearSelect').on('changed.bs.select', function() { ppOnTaxYearChange(); });
    $('#ppPeriodSelect').on('changed.bs.select', function() { ppOnPeriodChange(); });
});
</script>
@endpush
