...
class DocManagerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('cimsdocmanager::documents.index', compact('documents', 'stats', 'categories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('cimsdocmanager::documents.form', compact(
    ...
    public function show($id)
    {
        ...
        return view('cimscore::partials.cims_master_document_viewer', compact('document'));
    }
    ...
    public function preview($id)
    {
        ...
        return view('cimsdocmanager::documents.preview', compact('document'));
    }
