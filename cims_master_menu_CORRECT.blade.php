...
<div class="cims-menu-wrapper">
    <div class="cims-nav-container">
        <ul class="cims-main-menu">
            ...
            {{-- ============================================================
                 SUNSHINE - Main Menu Item 1 (HIDDEN)
                 ============================================================
            ...
            {{-- ============================================================
                 ENTITIES - Main Menu Item 2 (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            <li class="cims-menu-item">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Clients, addresses, persons</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="{{ Route::has('client.index') ? route('client.index') : '#' }}"><i class="fas fa-id-card-clip"></i> Clients</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Maintain client records</div>
                    </li>
                    <li>
                        <a href="{{ Route::has('cimsaddresses.index') ? route('cimsaddresses.index') : '#' }}"><i class="fas fa-map-location-dot"></i> Addresses</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Maintain addresses</div>
                    </li>
                    <li>
                        <a href="{{ Route::has('cimspersons.index') ? route('cimspersons.index') : '#' }}"><i class="fas fa-user-pen"></i> Persons</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Maintain persons</div>
                    </li>
                    <li>
                        <a href="{{ Route::has('nsdcpersons.index') ? route('nsdcpersons.index') : '#' }}"><i class="fas fa-users"></i> NSDC Persons</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">NSDC persons list</div>
                    </li>
                </ul>
            </li>

            {{-- ============================================================
                 ACCOUNTING - Main Menu Item 3 (HIDDEN)
                 ============================================================ --}}
            {{-- <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            {{-- ============================================================
                 SALES - Main Menu Item (GrowCRM Sales Module) (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Estimates, subscriptions, expenses</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="/estimates"><i class="fas fa-file-signature"></i> Estimates</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Create & send estimates</div>
                    </li>
                    <li>
                        <a href="/subscriptions"><i class="fas fa-sync-alt"></i> Subscriptions</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Recurring billing</div>
                    </li>
                    <li>
                        <a href="/expenses"><i class="fas fa-receipt"></i> Expenses</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Track business expenses</div>
                    </li>
                </ul>
            </li>
            --}}
            ...
            <li class="cims-menu-item">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Invoices, payments, services, statements</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="/invoices"><i class="fas fa-file-invoice"></i> Invoices</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Manage client invoices</div>
                    </li>
                    <li>
                        <a href="/payments"><i class="fas fa-credit-card"></i> Payments</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Track received payments</div>
                    </li>
                    <li>
                        <a href="/products"><i class="fas fa-boxes-stacked"></i> Services</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Products & services catalog</div>
                    </li>
                    <li>
                        <a href="/statements"><i class="fas fa-file-lines"></i> Statements</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Customer statements of account</div>
                    </li>
                    <li>
                        <a href="/aged-analysis"><i class="fas fa-chart-bar"></i> Age Analysis</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Debtor age analysis report</div>
                    </li>
                </ul>
            </li>

            {{-- ============================================================
                 JOB CARDS - Main Menu Item
                 ============================================================ --}}
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Job card workflow, tracking & management</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="/job-cards/dashboard"><i class="fas fa-gauge-high"></i> Dashboard</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Job cards overview & stats</div>
                    </li>
                    <li>
                        <a href="/job-cards"><i class="fas fa-list-check"></i> All Job Cards</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">View & manage all job cards</div>
                    </li>
                    <li>
                        <a href="/job-cards/create"><i class="fas fa-plus-circle"></i> Create Job Card</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Create a new job card</div>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-cogs"></i> Admin Setup</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Configure job card types & workflows</div>
                        <ul class="cims-submenu-level3">
                            <li><a href="/job-cards/admin/types"><i class="fas fa-tags"></i> Job Types</a></li>
                            <li><a href="/job-cards/admin/types/1/steps"><i class="fas fa-shoe-prints"></i> Steps</a></li>
                            <li><a href="/job-cards/admin/types/1/fields"><i class="fas fa-input-text"></i> Fields</a></li>
                            <li><a href="/job-cards/admin/types/1/documents"><i class="fas fa-file-circle-check"></i> Document Requirements</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            {{-- ============================================================
                 TAXATION - Main Menu Item 4 (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            {{-- ============================================================
                 ...
                 ============================================================ --}}
            <li class="cims-menu-item">
                <a href="{{ route('cimspayroll.dashboard') }}" class="cims-menu-link">
                    <i class="fas fa-wallet"></i>
                    <span>Payroll</span>
                </a>
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Payroll management — BCEA compliant</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="{{ route('cimspayroll.dashboard') }}"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Payroll overview</div>
                    </li>
                    <li>
                        <a href="{{ route('cimspayroll.processing') }}"><i class="fas fa-user-cog"></i> Payroll Processing</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Process employees — all tabs</div>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-cogs"></i> Setup</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Master data setup</div>
                        <ul class="cims-submenu-level3">
                            <li><a href="{{ route('cimspayroll.companies.index') }}">Companies</a></li>
                            <li><a href="{{ route('cimspayroll.employees.index') }}">Employees</a></li>
                            <li><a href="{{ route('cimspayroll.income-types.index') }}">Income Types</a></li>
                            <li><a href="{{ route('cimspayroll.deduction-types.index') }}">Deduction Types</a></li>
                            <li><a href="{{ route('cimspayroll.contribution-types.index') }}">Company Contributions</a></li>
                            <li><a href="{{ route('cimspayroll.tax-tables.index') }}">Tax Tables</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-clock"></i> Hours & Attendance</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Timesheets & leave</div>
                        <ul class="cims-submenu-level3">
                            <li><a href="{{ route('cimspayroll.timesheets.index') }}">Timesheets</a></li>
                            <li><a href="{{ route('cimspayroll.leave-types.index') }}">Leave Types</a></li>
                            <li><a href="{{ route('cimspayroll.leave.balances') }}">Leave Balances</a></li>
                            <li><a href="{{ route('cimspayroll.leave.applications') }}">Leave Applications</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-play-circle"></i> Process</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Pay runs & loans</div>
                        <ul class="cims-submenu-level3">
                            <li><a href="{{ route('cimspayroll.pay-runs.index') }}">Pay Runs</a></li>
                            <li><a href="{{ route('cimspayroll.loans.index') }}">Loans Register</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{ route('cimspayroll.payslips.index') }}"><i class="fas fa-file-invoice-dollar"></i> Payslips</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Generate payslips</div>
                    </li>
                    <li>
                        <a href="{{ route('cimspayroll.paye-calculator') }}"><i class="fas fa-calculator"></i> PAYE Calculator</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Cost-to-company tax simulator</div>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><i class="fas fa-chart-bar"></i> Reports</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Payroll reports</div>
                        <ul class="cims-submenu-level3">
                            <li><a href="{{ route('cimspayroll.reports.payroll-summary') }}">Payroll Summary</a></li>
                            <li><a href="{{ route('cimspayroll.reports.paye') }}">PAYE Report</a></li>
                            <li><a href="{{ route('cimspayroll.reports.uif') }}">UIF Report</a></li>
                            <li><a href="{{ route('cimspayroll.reports.leave') }}">Leave Report</a></li>
                            <li><a href="{{ route('cimspayroll.reports.loans') }}">Loan Report</a></li>
                            <li><a href="{{ route('cimspayroll.reports.cost-to-company') }}">Cost to Company</a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="cims-menu-item">
                ...
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">EMP201, EMP501, EMPSA returns</div>
                <ul class="cims-submenu">
                    <li>
                        <a href="{{ route('cimsemp201.index') }}"><i class="fas fa-list"></i> All EMP201</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">View all EMP201 returns</div>
                    </li>
                    <li>
                        <a href="{{ route('cimsemp201.create') }}"><i class="fas fa-plus-circle"></i> New EMP201</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Create a new EMP201 return</div>
                    </li>
                    <li>
                        <a href="{{ route('cimsemp201.pivot') }}"><i class="fas fa-table-columns"></i> EMP201 / EMP501 Pivot</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">EMP201 and EMP501 pivot view</div>
                    </li>
                    <li>
                        <a href="{{ route('cimsemp201.statement') }}"><i class="fas fa-file-lines"></i> Statement of Account (EMPSA)</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">EMPSA statement of account</div>
                    </li>
                </ul>
            </li>

            {{-- ============================================================
                 COMPLIANCE - Main Menu Item 6 (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            {{-- ============================================================
                 CONTRACTS - Main Menu Item 7 (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="javascript:void(0);" class="cims-menu-link">
            ...
            <li class="cims-menu-item">
                ...
                <ul class="cims-submenu">
                    ...
                    <li>
                        <a href="{{ Route::has('cimsemail.signature') ? route('cimsemail.signature') : '#' }}"><i class="fas fa-signature"></i> My Signature</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Set up your email signature</div>
                    </li>
                    <li>
                        <a href="{{ Route::has('cimsemail.settings') ? route('cimsemail.settings') : '#' }}"><i class="fas fa-cog"></i> SMTP Settings</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Configure outgoing email server</div>
                    </li>
                </ul>
            </li>
            ...
            <li class="cims-menu-item">
                ...
                <ul class="cims-submenu">
                    ...
                    <li>
                        <a href="/cims/pm/system-settings"><i class="fas fa-cogs"></i> System Settings</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Firm configuration</div>
                    </li>
                    <li>
                        <a href="{{ route('cimsbankconv.convert') }}"><i class="fas fa-exchange-alt"></i> Bank QB Uploads</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Bank statement to QuickBooks</div>
                    </li>
                    <li>
                        <a href="javascript:void(0);" onclick="cimsClearCache('{{ route('cimscore.clear-cache') }}')"><i class="fas fa-broom"></i> Clear Cache</a>
                        <div class="sd_tooltip_teal sd-menu-tooltip">Clear all system caches</div>
                    </li>
                </ul>
            </li>

            {{-- ============================================================
                 WEBSITE - Preview Website (HIDDEN)
                 ============================================================
            <li class="cims-menu-item">
                <a href="/smartweigh-website.html" target="_blank" class="cims-menu-link">
                    <i class="fas fa-globe"></i>
                    <span>Website</span>
                </a>
                <div class="sd_tooltip_teal sd-mainmenu-tooltip">Preview SmartWeigh website</div>
            </li>
            --}}
