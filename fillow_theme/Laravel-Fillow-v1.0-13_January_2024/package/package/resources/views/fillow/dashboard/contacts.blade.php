    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="mb-4">
                ...
                <a href="#" class="add btn btn-primary btn-rounded" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">+ New Contact</a>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-12">
                <div class="row">
                    <div class="col-xl-2 col-xxl-3 col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic1.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
                                    <h5 class="mb-0"><a href="{{ url('app-profile') }}" class="text-black user-name"
                                            data-name="Alan Green">Jakob Gouse</a></h5>
                    ...
                    <div class="col-xl-2 col-xxl-3 col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic2.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
                                    <h5 class="mb-0"><a href="{{ url('app-profile') }}" class="text-black user-name"
                                            data-name="Alan Green">Gretchen Aminoff</a></h5>
                    ...
                    <div class="col-xl-2 col-xxl-3 col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic3.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
                                    <h5 class="mb-0"><a href="{{ url('app-profile') }}" class="text-black user-name"
                                            data-name="Alan Green">Davis Siphron</a></h5>
                    ...
                    <div class="col-xl-2 col-xxl-3 col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic4.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
                                    <h5 class="mb-0"><a href="{{ url('app-profile') }}" class="text-black user-name"
                                            data-name="Alan Green">Zaire Lubin</a></h5>
                                    <p class=" mb-3" data-occupation="UI Designer">Highspeed Inc.</p>
                                    <ul>
                                        <li><a href="javascript:void(0);"><i class="fas fa-phone-alt"></i></a></li>
                                        <li><a href="javascript:void(0);"><i class="far fa-comment-alt"></i></a></li>
                    ...
                    <div class="col-xl-2 col-xxl-3 col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic6.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
                    ...
                    <div class="col-xl-2 col-xxl-3  col-md-4 col-sm-6 items">
                        <div class="card contact-bx item-content">
                            ...
                            <div class="card-body user-profile">
                                <div class="image-bx">
                                    <img src="{{ asset('images/pic5.jpg') }}" data-src="{{ asset('images/contacts/Untitled-3.jpg') }}" alt=""
                                        class="rounded-circle">
                                    <span class="active"></span>
                                </div>
                                <div class="media-body user-meta-info">
