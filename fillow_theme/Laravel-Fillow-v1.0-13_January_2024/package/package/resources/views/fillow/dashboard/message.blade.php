                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                        ...
                                        <div class="chat-sidebar" id="chatSidebar">
                                            ...
                                            <div class="chat-bx d-flex active mb-2 border-bottom">
                                                <div class="group-pic">
                                                    <div class="d-flex">
                                                        <img src="{{ asset('images/group/g1.jpg') }}" alt="">
                                                        <img src="{{ asset('images/group/g2.jpg') }}" alt="">
                                                    </div>
                                                    <div class="d-flex">
                                                        <img src="{{ asset('images/group/g3.jpg') }}" alt="">
                                                        <img src="{{ asset('images/group/g4.jpg') }}" alt="">
                                                    </div>
                                                </div>
                                                <div class="w-100">
                                                    ...
                                                    <p class="mb-0">Hey Jenny, don’t forget to prepare prototype for next
                                                        week</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="chat-bx d-flex border-bottom">
                                                <div class="chat-img">
                                                    <img src="{{ asset('images/contacts/pic11.jpg') }}" alt="">
                                                </div>
                                                <div class="w-100">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <p class="mb-0 lh-base">I remember that project due is tomorrow.
                                                        </p>
                                                        <span>
                                                            <svg class="mt-4" width="24" height="24"
                                                                viewBox="0 0 24 24" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <g clip-path="url(#clip0)">
                                                                    <path
                                                                        d="M16.4935 6.34536C16.0279 5.87458 15.2693 5.86865 14.7964 6.33213L5.92643 15.0987L2.07056 11.1069C1.61067 10.6276 0.849313 10.6118 0.370044 11.0717C-0.109276 11.5316 -0.125009 12.293 0.334881 12.7723C0.336964 12.7744 0.338996 12.7765 0.34108 12.7787L5.0425 17.6508C5.26749 17.8804 5.57501 18.0103 5.89643 18.0116H5.90966C6.22499 18.0107 6.52734 17.8858 6.75156 17.6641L16.4826 8.04239C16.9528 7.57614 16.9576 6.8176 16.4935 6.34536Z"
                                                                        fill="#886CC0" />
                                                                    <path
                                                                        d="M12.2591 17.6509C12.4835 17.8798 12.79 18.0097 13.1106 18.0117H13.1238C13.4392 18.0107 13.7415 17.8859 13.9657 17.6641L23.6969 8.0424C24.1379 7.54574 24.0929 6.78557 23.5963 6.34449C23.146 5.94461 22.4695 5.93935 22.0131 6.33215L13.1467 15.0987L12.8303 14.7703C12.3705 14.291 11.6092 14.2752 11.1298 14.7351C10.6505 15.195 10.6347 15.9563 11.0946 16.4356C11.0967 16.4378 11.0988 16.44 11.1009 16.4421L12.2591 17.6509Z"
                                                                        fill="#886CC0" />
                                                                </g>
                                                                <defs>
                                                                    <clipPath id="clip0">
                                            ...
                                            <div class="chat-bx d-flex border-bottom">
                                                <div class="chat-img">
                                                    <img src="{{ asset('images/contacts/pic22.jpg') }}" alt="">
                                                </div>
                                                <div class="w-100">
                                                    <div class="d-flex mb-1 align-items-center">
                                            ...
                                            <div class="chat-bx d-flex border-bottom">
                                                <div class="chat-img">
                                                    <img src="{{ asset('images/contacts/pic33.jpg') }}" alt="">
                                                </div>
                                                <div class="w-100">
                                                    <div class="d-flex mb-1 align-items-center">
                            ...
                            <div class="col-xl-9 col-xxl-8 ps-xl-0">
                                ...
                                <div class="chat-box-area dlab-scroll chat-box-area" id="chatArea">
                                    <div class="chat-box-area dz-scroll" id="chartBox">
                                        <div class="media my-4  justify-content-start align-items-start">
                                            ...
                                            <div class="message-received">
                                                <p class="mb-1">
                                                    ...
                                                    explicabo. Nemo enim ipsam voluptat
                                                </p>
                                        ...
                                        <div class="media my-4  justify-content-start align-items-start">
                                            ...
                                            <div class="message-received">
                                                <p class="mb-1 me-5">
                                                    Hey, check my design update last night. Tell me what you think and if
                                                    that is OK
                                                </p>
                                                <small class="text-gray">Sunday, October 24th, 2020 at 4.30 AM</small>
                                            </div>
                                        ...
                                        <div class="media mb-4 justify-content-end align-items-end">
                                            ...
                                            <div class="image-box ms-sm-3 ms-2 mb-4">
                                                <img src="{{ asset('images/contacts/3.jpg') }}" alt=""
                                                    class="rounded-circle img-1">
                                                <span class="active1"></span>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer border-0 type-massage">
                                    ...
                                    <div class="input-group-append d-flex justify-content-between flex-wrap">
                                        <div>
                                            ...
                                            <button type="button" class="btn">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M9.87973 5.03707C10.338 4.98187 11.4952 4.99997 11.9997 4.99997V2.99997C11.9999 2.82307 12.047 2.64939 12.1362 2.49661C12.2254 2.34384 12.3535 2.21744 12.5074 2.1303C12.6613 2.04315 12.8356 1.99838 13.0125 2.00053C13.1894 2.00269 13.3626 2.0517 13.5143 2.14257L21.5143 6.94257C21.6622 7.03156 21.7845 7.15728 21.8695 7.30751C21.9544 7.45775 21.999 7.62739 21.999 7.79997C21.999 7.97255 21.9544 8.14219 21.8695 8.29243C21.7845 8.44266 21.6622 8.56838 21.5143 8.65737L13.5143 13.4574C13.3626 13.5482 13.1894 13.5972 13.0125 13.5994C12.8356 13.6016 12.6613 13.5568 12.5074 13.4696C12.3535 13.3825 12.2254 13.2561 12.1362 13.1033C12.047 12.9506 11.9999 12.7769 11.9997 12.6V11H9.99973C8.06973 11 5.00973 12.6973 5.00973 17.25C5.00923 17.4696 4.93651 17.6829 4.80278 17.857C4.66905 18.0312 4.48174 18.1566 4.26974 18.2137C4.05773 18.2709 3.83279 18.2568 3.62962 18.1735C3.42644 18.0902 3.2563 17.9424 3.14543 17.7529C2.42495 16.5077 2.0328 15.0998 2.00583 13.6614C1.97886 12.223 2.31796 10.8014 2.99125 9.53007C3.66455 8.25873 4.64997 7.17941 5.85493 6.39347C7.05989 5.60754 8.44486 5.14079 9.87973 5.03707Z"
                                                        fill="var(--text-gray)" />
                                                </svg>
                                            </button>
                                            <button type="button" class="btn">
                                            ...
                                            <button type="button" class="btn">
                                                <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M8.21951 17C7 17 5.9187 16.7743 4.97561 16.323C4.04878 15.8717 3.31707 15.1613 2.78049 14.1917C2.26016 13.2055 2 11.91 2 10.3053V7.59734C2 6.66126 2 5.71681 2 4.76401C2 3.81121 1.99187 2.85005 1.97561 1.88053C1.97561 1.22861 1.6748 0.819076 1.07317 0.651916L0.536585 0.526548V0H7.12195V0.526548L6.43902 0.676991C5.82114 0.827434 5.5122 1.24533 5.5122 1.93068C5.49593 2.86676 5.48781 3.81121 5.48781 4.76401C5.48781 5.7001 5.48781 6.64454 5.48781 7.59734V10.7817C5.48781 12.4031 5.80488 13.5733 6.43902 14.292C7.08943 15.0108 8.00813 15.3702 9.19512 15.3702C10.4472 15.3702 11.4228 14.9857 12.122 14.2168C12.8374 13.4312 13.1951 12.2694 13.1951 10.7316V2.0059C13.1951 1.67158 13.1301 1.37906 13 1.12832C12.8699 0.87758 12.6423 0.71878 12.3171 0.651916L11.7317 0.526548V0H15.4878V0.526548L14.8049 0.676991C14.4959 0.743854 14.2846 0.894296 14.1707 1.12832C14.0569 1.36234 14 1.64651 14 1.98083V10.5811C14 12.6539 13.4715 14.2419 12.4146 15.3451C11.3577 16.4484 9.95935 17 8.21951 17Z"
                                                        fill="#717579" />
                                        ...
                                        <div>
                                            <button type="button" class="btn pr-0"><i
                                                    class="fas fa-smile scale5 text-primary"></i></button>
                                            <input type="file" id="attachmentInput" style="display: none;">
                                            <button type="button" id="attachButton" class="btn"><i
                                                    class="fas fa-paperclip scale5 text-primary"></i></button>
                                            <button type="button" class="btn btn-primary rounded text-white"><i
                                                    class="far fa-paper-plane me-2"></i>SEND</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
