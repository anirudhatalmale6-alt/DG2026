                            ...
                            <div>
                                ...
                                <div class="d-flex align-items-center mt-4 flex-wrap">
                                    <ul class="kanbanimg me-3">
                                        <li><img src="{{ asset('images/profile/small/pic1.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/profile/small/pic2.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/profile/small/pic3.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/profile/small/pic4.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/profile/small/pic5.jpg') }}" alt=""></li>
                                        <li><span>5+</span></li>
                                    </ul>
                                    <div class="ms-xl-4 ms-0 my-3 my-sm-0 invite">
                                        <a href="javascript:void(0);"
                                            class="btn btn-primary light btn-rounded mb-sm-0 mb-2 me-2 btn-sm"><i
                                                class="fas fa-user-plus me-3 scale2"></i>Invite People</a>
                                        <a href="javascript:void(0);" class="btn btn-primary light btn-rounded btn-sm"><i
                    ...
                    <div class="draggable-zone dropzoneContainer">
                        ...
                        <div class="card draggable-handle draggable">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0"><a href="javascript:void(0);" class="text-black">Create wireframe for
                                        landing page phase 1</a></h5>
                                <div class="progress default-progress my-4">
                                    <div class="progress-bar bg-design progress-animated" style="width: 45%; height:7px;"
                                        role="progressbar">
                                        <span class="sr-only">45% Complete</span>
                                    </div>
                                </div>
                                <div class="row justify-content-between align-items-center kanban-user">
                                    <ul class="users col-6">
                                        <li><img src="{{ asset('images/contacts/pic11.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/contacts/pic22.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/contacts/pic33.jpg') }}" alt=""></li>
                                    </ul>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-warning">
                                        <svg class="me-2" width="10" height="10" viewBox="0 0 10 10"
                                ...
                                <h5 class="mb-0"><a href="javascript:void(0);" class="text-black">Visual Graphic for
                                        Presentation to Client</a></h5>
                                <div class="progress default-progress my-4">
                                    <div class="progress-bar bg-warning progress-animated" style="width: 45%; height:7px;"
                                        role="progressbar">
                                        <span class="sr-only">45% Complete</span>
                                    </div>
                                </div>
                                <div class="row justify-content-between align-items-center kanban-user">
                                    <ul class="users col-6">
                                        ...
                                        <li><img src="{{ asset('images/contacts/pic22.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/contacts/pic33.jpg') }}" alt=""></li>
                                        <li><img src="{{ asset('images/contacts/pic222.jpg') }}" alt=""></li>
                                    </ul>
                                    <div class="col-6 d-flex justify-content-end">
                    ...
                    <div class="draggable-zone dropzoneContainer">
                        ...
                        <div class="card draggable-handle draggable">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0"><a href="javascript:void(0);" class="text-black">Update information in
                                        footer section</a></h5>
                                <div class="progress default-progress my-4">
                                    <div class="progress-bar bg-danger progress-animated" style="width: 45%; height:7px;"
                                        role="progressbar">
                                        <span class="sr-only">45% Complete</span>
                                    </div>
                                </div>
                        ...
                        <div class="card draggable-handle draggable">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0"><a href="javascript:void(0);" class="text-black">Update information in
                                        footer section</a></h5>
                                <div class="progress default-progress my-4">
                                    <div class="progress-bar bg-success progress-animated" style="width: 45%; height:7px;"
                                        role="progressbar">
                                        <span class="sr-only">45% Complete</span>
                                    </div>
                                </div>
                        ...
                        <div class="card draggable-handle draggable">
                            <div class="card-body">
                                ...
                                <h5 class="mb-0"><a href="javascript:void(0);" class="text-black">Update information in
                                        footer section</a></h5>
                                <div class="progress default-progress my-4">
                                    <div class="progress-bar bg-info progress-animated" style="width: 45%; height:7px;"
                                        role="progressbar">
                                        <span class="sr-only">45% Complete</span>
                                    </div>
                                </div>
