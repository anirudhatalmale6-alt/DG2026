                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <label class="form-check-label form-label mb-0 ms-3"
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header pb-0 border-0">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" class="btn btn-outline-primary btn-rounded">View
                                                More</a>
                                        </div>
                                    </div>
                                    <div class="card-body px-0 pt-2">
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <P class="text-black mb-0">Lorem ipsum dolor sit amet, consectetur
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{ asset('images/profile/small/pic6.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3">
                                                    <a href="{{ url('email-inbox') }}">
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{ asset('images/profile/small/pic8.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3">
                                                    <a href="{{ url('email-inbox') }}">
                                                        <h4 class="fs-18 font-w500">How to improve project management flows
                                        ...
                                        <div class="card">
                                            <div
                                                ...
                                                <div class="w-75">
                                                    ...
                                                    <div class="mt-2">
                                                        <p class="mb-0"><strong class="text-danger me-2">76</strong>left
                                                            from target</p>
                                            ...
                                            <div class="card-body d-flex px-4  justify-content-between">
                                                <div>
                                                    <div class="">
                                                        ...
                                                        <p class="mb-0"><strong class="text-danger">-2%</strong> than
                                                            last month</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-sm-6">
                                                <div class=" owl-carousel card-slider">
                                                    <div class="items">
                                                        <h4 class="card-title mb-4">Fillow Company Profile Website Project
                                                        </h4>
                                                        <span class="fs-14 font-w400 text-black">Lorem ipsum dolor sit,
                                                            amet consectetur adipisicing elit. Id quibusdam eaque vero ullam
                                                            odit nostrum nemo excepturi explicabo ipsum voluptas nihil quae
                                                            doloremque ducimus. </span>
                                                    </div>
                                                    <div class="items">
                                                        <h4 class="fs-20 font-w700 mb-4">Fillow Company Profile Website
                                                            Project</h4>
                                                        <span class="fs-14 font-w400 text-black">Lorem ipsum dolor, sit
                                                            amet consectetur adipisicing elit. Ab autem, quae debitis
                                                            voluptatum omnis, quaerat deserunt nam voluptates exercitationem
                                                            facere sequi dolorem. </span>
                                                    </div>
                                                    <div class="items">
                                                        <h4 class="fs-20 font-w700 mb-4">Fillow Company Profile Website
                                                            Project</h4>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body pb-0">
                                                ...
                                                <div class="email-lagend">
                                                    ...
                                                    <div
                                                        class="d-flex align-items-center justify-content-between  mb-0 spam">
                                                        <span class="fs-16 text-gray">
                                                            <svg class="me-2" width="20" height="20"
                                                                viewBox="0 0 20 20" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="card-footer border-0 pt-0">
                                                <a href="javascript:void(0);"
                                                    class="btn btn-outline-primary btn-rounded d-block">Update Progress</a>
                                            ...
                                            <div class="card-body pb-0 pt-3">
                                                <div class="project-details">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <div class="big-wind">
                                                                <img src="{{ asset('images/big-wind.png') }}" alt="">
                                                            </div>
                                                            <div class="ms-3">
                                                    ...
                                                    <h5 class="mt-3">Optimization Dashboard Page for indexing in Google
                                                    </h5>
                                                    <div class="projects">
                                                    ...
                                                    <div class="mt-3">
                                                        <div class="progress default-progress">
                                                            <div class="progress-bar bg-gradient1 progress-animated"
                                                                style="width: 45%; height:5px;" role="progressbar">
                                                                <span class="sr-only">45% Complete</span>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex align-items-end mt-3 justify-content-between">
                                                            <p class="mb-0"><strong
                                                                    class="text-black me-2">12</strong>Task Done</p>
                                                ...
                                                <div class="project-details">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
                                                            <span class="big-wind">
                                                                <img src="{{ asset('images/circle-hunt.png') }}" alt="">
                                                            </span>
                                                            <div class="ms-3">
                                                    ...
                                                    <h5 class="mt-3">Redesign Landing Page Website for Company Profile
                                                    </h5>
                                                    <div class="projects">
                                ...
                                <div class="card">
                                    <div class="card-header pb-0 border-0">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);" class="btn btn-primary btn-rounded"
                                                data-bs-toggle="modal" data-bs-target="#sendMessageModal">+ New
                                                Messages</a>
                                        </div>
                                    </div>
                                    <div class="card-body px-0 pt-0">
                                            ...
                                            <div class="msg d-flex align-items-center w-100">
                                                ...
                                                <div class="ms-3 w-100 ">
                                                    <a href="{{ url('app-profile') }}">
                                                        <h5 class="mb-1">Maren Rosser</h5>
                                                    </a>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="me-auto mb-0 text-black">Hei, dont forget to clear server
                                                            cache!</p>
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box">
                                                    <img src="{{ asset('images/profile/small/pic7.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                                    <a href="{{ url('app-profile') }}">
                                                        <h5 class="mb-1">Kaiya Bergson</h5>
                                                    </a>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="me-auto mb-0 text-black">I remember that project due is
                                                            tomorrow.</p>
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('images/profile/small/pic4.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                                    <a href="{{ url('app-profile') }}">
                                                        <h5 class="mb-1">Ruben Press</h5>
                                                    </a>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="me-auto mb-0 text-black">Ok sir. I will fix it as soon as
                                                            possible</p>
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('images/profile/small/pic3.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                                    <a href="{{ url('app-profile') }}">
                                                        <h5 class="mb-1">Cristofer Torff</h5>
                                                    </a>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="me-auto mb-0 text-black">Maybe we should schedule that
                                                            meeting</p>
                                                        <small class="me-4">December 12th, 2020 10:24 AM</small>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{ asset('images/profile/small/pic5.jpg') }}" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                                    <a href="{{ url('app-profile') }}">
                                                        <h5 class="mb-1">Ann Rosser</h5>
                                                    </a>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="me-auto mb-0 text-black">I dont’t know where that files
                                                            saved dude.</p>
                                                        <small class="me-4">Yesterday, 8:24 AM</small>
                                                    </div>
                                                </div>
