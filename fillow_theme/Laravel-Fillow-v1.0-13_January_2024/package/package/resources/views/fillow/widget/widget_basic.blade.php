        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
                <div class="card text-white bg-primary">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0 text-white">Blood
                                type :</span><strong class="text-white">O+</strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span
                                class="mb-0 text-white">Allergies :</span><strong class="text-white">Penicilin, peanuts
                            </strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span
                                class="mb-0 text-white">Pressure :</span><strong class="text-white">120/100
                                mmHG</strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span
                                class="mb-0 text-white">Diseases :</span><strong class="text-white">Diabetes</strong>
                        </li>
                        <li class="list-group-item d-flex justify-content-between"><span
                                class="mb-0 text-white">Temperture :</span><strong class="text-white">34 Degree</strong>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card text-white text-black">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Regular
                                Checkups</span></li>
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Dr Theodore
                                Handle :</span><strong>Dentist</strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Dr Valentino
                                Morose :</span><strong>Surgeon</strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Dr Fleece
                                Marigold :</span><strong>Clinical</strong></li>
                        <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Dr Eric Widget
                                :</span><strong>Cardiology</strong></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
                <div class="card">
                    <div class="card-body text-center ai-icon  text-primary">
                        ...
                        <a href="javascript:void();;" class="btn my-2 btn-primary px-4"><i class="fa fa-usd"></i> Earn
                            Budges</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-12 col-sm-12">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-footer mt-0">
                        <a href="./index.html" class="btn btn-primary btn-block">View Profile</a>
                    </div>
                </div>
            </div>
