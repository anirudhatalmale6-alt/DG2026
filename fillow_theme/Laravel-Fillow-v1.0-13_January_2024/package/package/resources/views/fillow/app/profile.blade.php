                            ...
                            <div class="profile-details">
                                ...
                                <div class="dropdown ms-auto">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                    class="fa fa-users text-primary me-2"></i> Add to btn-close friends</a>
                                        </li>
                                        <li class="dropdown-item"><a href="javascript:void(0);"><i
                                                    ...
                                                    <form class="comment-form">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="text-black font-w600 form-label required">Name
                                                                    </label>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label
                                                                        class="text-black font-w600 form-label required">Email</label>
                                                                    <input type="text" class="form-control"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="profile-blog">
                                    ...
                                    <h4><a href="{{ url('post-details') }}" class="text-black">Darwin Creative Agency Theme</a>
                                    </h4>
                                ...
                                <div class="profile-news">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Empower
                                                    your project management.</a></h5>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('images/profile/6.jpg') }}" alt="image" class="me-3 rounded"
                                            width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Streamline
                                                    project oversight and control.</a></h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('images/profile/7.jpg') }}" alt="image" class="me-3 rounded"
                                            width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="{{ url('post-details') }}" class="text-black">Collection
                                        ...
                                        <div class="my-post-content pt-3">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <div class="form-file rounded-end">
                                                                        <input type="file"
                                                                            class="form-file-input form-control rounded-end">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                ...
                                                <a class="post-title" href="{{ url('post-details') }}">
                                                    <h3 class="text-black">Elevate your project management efficiency</h3>
                                                </a>
                                            ...
                                            <div class="profile-uoloaded-post pb-3">
                                                <img src="{{ asset('images/profile/8.jpg') }}" alt=""
                                                    class="img-fluid w-100 rounded">
                                                <a class="post-title" href="{{ url('post-details') }}">
                                                    <h3 class="text-black">Unlock the full potential of your projects.</h3>
                                                </a>
                                                <p>A wonderful serenity has take possession of my entire soul like these
                                                    sweet morning of spare which enjoy whole heart.A wonderful serenity has
                                                    take possession of my entire soul like these sweet morning
