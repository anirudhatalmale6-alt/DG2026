                        ...
                        <div class="card-footer">
                            ...
                            <div class="input-group">
                                <a href="https://www.dexignlab.com/" target="_blank"
                                    class="form-control text-primary rounded text-start bg-white fs-16">https://www.dexignlab.com/</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 m-b30">
                                    ...
                                    <input type="text" class="form-control mb-3 mb-xl-0" placeholder="2017-06-04"
                                        id="datepicker">
                                </div>
                                <div class="col-sm-6 m-b30">
