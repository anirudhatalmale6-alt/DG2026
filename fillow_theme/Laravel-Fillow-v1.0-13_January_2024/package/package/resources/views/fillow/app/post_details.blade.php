                            ...
                            <div class="card-body">
                                <div class="post-details">
                                    ...
                                    <ul class="mb-4 post-meta d-flex flex-wrap">
                                        ...
                                        <li class="post-date me-3"><i class="far fa-calendar-plus me-2"></i>18 Nov 2020
                                        </li>
                                    ...
                                    <div class="comment-respond" id="respond">
                                        ...
                                        <form class="comment-form" id="commentform" method="post">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="author" class="text-black font-w600 form-label">Name
                                                        </label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="email"
                                                            class="text-black font-w600 form-label">Email </label>
