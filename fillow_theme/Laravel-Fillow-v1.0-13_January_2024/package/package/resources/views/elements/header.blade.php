									...
									<div class="p-3 pb-0">
										<div class="row">
											...
											<div class="col-4 my-3">
												<div class="text-center">
													<div class="angular-svg">
														<img src="{{ asset('images/svg/angular.svg') }}" alt="">
														<div class="content">
															<small>Angular</small>
														</div>
													</div>
											...
											<div class="col-4 my-3">
												<div class="text-center">
													<div class="angular-svg">
														<img src="{{ asset('images/svg/figma.svg') }}" alt="">
														<div class="content">
															<small>Figma</small>
														</div>
													</div>
											...
											<div class="col-4 my-3">
												<div class="text-center">
													<div class="angular-svg">
														<img src="{{ asset('images/svg/dribbble.svg') }}" alt="">
														<div class="content">
											...
											<div class="col-4">
												<div class="text-center">
													<div class="angular-svg">
														<img src="{{ asset('images/svg/laravel-2.svg') }}" alt="">
														<div class="content">
															<small>Laravel</small>
														</div>
													</div>
											...
											<div class="col-4">
												<div class="text-center">
													<div class="angular-svg">
														<img src="{{ asset('images/svg/react-2.svg') }}" alt="">
														<div class="content">
															<small>React</small>
														</div>
													</div>
