...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-invoices">@lang('lang.filtered')</a>.
        @lang('lang.you_can')
        <a href="{{ url('/invoices?clear-filter=yes') }}">@lang('lang.clear_the_filters')</a>.
    </small>
</div>
@endif
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            ...
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_bill_projectid"
                                href="javascript:void(0)"
                        ...
                        <th
                            ...
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_bill_tax_total_amount"
                                href="javascript:void(0)"
                        ...
                        <th style="text-align: right;"
                            ...
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_bill_final_amount"
                                href="javascript:void(0)"
                        ...
                        <th
                            class="invoices_col_tableconfig_column_23 {{ config('table.tableconfig_column_23') }} tableconfig_column_23">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_bill_status"
                                href="javascript:void(0)"
