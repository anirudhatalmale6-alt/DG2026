        ...
        <table class="table table-hover invoice-table {{ config('css.bill_mode') }}">
            <thead>
                <tr>
                    ...
                    <!--rate-->
                    <th class="text-right x-rate bill_col_rate">{{ cleanLang(__('lang.rate')) }}</th>
                    <!--discount-->
                    <th style="display:none;"
                        class="text-left x-discount bill_col_discount {{ runtimeVisibility('invoice-column-inline-discount', $bill->bill_tax_type) }}">
                        @lang('lang.discount')
                    </th>
                    <!--tax-->
                    <th style="display:none;"
