...
return [
    ...
    'stubs' => [
        ...
        'files' => [
            ...
            'nextloop-module-stubs/middleware/BootSystem.php' => 'Http/Middleware/BootSystem.php',

            //NEXTLOOP - LISTENER
            'nextloop-module-stubs/listen/MainApp/ViewRendering.php' => 'Listeners/MainApp/ViewRendering.php',
            'nextloop-module-stubs/listen/Settings/ViewRendering.php' => 'Listeners/Settings/ViewRendering.php',
            ...
            //NETLOOP - MENUS
            'nextloop-module-stubs/views/menus/main-client.blade.php' => 'Resources/views/menus/main-client.blade.php',
            'nextloop-module-stubs/views/menus/main-team.blade.php' => 'Resources/views/menus/main-team.blade.php',
            'nextloop-module-stubs/views/menus/settings.blade.php' => 'Resources/views/menus/settings.blade.php',
            'nextloop-module-stubs/views/header/content.blade.php' => 'Resources/views/header/content.blade.php',
            'nextloop-module-stubs/views/footer/content.blade.php' => 'Resources/views/footer/content.blade.php',
            ...
            //NEXTLOOP - ENV
            'nextloop-module-stubs/.env' => '.env',

            //AI TASKS
            'nextloop-module-stubs/AI-TASKS/TEMPLATES/create-plan.md' => 'AI-TASKS/TEMPLATES/create-plan.md',
            'nextloop-module-stubs/AI-TASKS/TEMPLATES/one-shot.md' => 'AI-TASKS/TEMPLATES/one-shot.md',
        ...
        'replacements' => [
            ...
            'nextloop-module-stubs/middleware/BootSystem.php' => ['STUDLY_NAME', 'LOWER_NAME'],

            //NEXTLOOP - LISTENER
            'nextloop-module-stubs/listen/MainApp/ViewRendering.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/listen/Settings/ViewRendering.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            ...
            //NETLOOP - MENUS
            'nextloop-module-stubs/views/menus/main-client.blade.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/views/menus/main-team.blade.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/views/menus/settings.blade.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/views/header/content.blade.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/views/footer/content.blade.php' => ['STUDLY_NAME', 'LOWER_NAME'],
            ...
            //NEXTLOOP - ENV
            'nextloop-module-stubs/.env' => ['STUDLY_NAME', 'LOWER_NAME'],

            //AI TASKS
            'nextloop-module-stubs/AI-TASKS/TEMPLATES/create-plan.md' => ['STUDLY_NAME', 'LOWER_NAME'],
            'nextloop-module-stubs/AI-TASKS/TEMPLATES/one-shot.md' => ['STUDLY_NAME', 'LOWER_NAME'],
