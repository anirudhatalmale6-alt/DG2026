...
Just include it on any page: @include('cimscore::partials.cims_master_footer')
    ...
    <div class="cims-footer-inner">
        ...
        <div class="cims-footer-left">
            <span class="cims-copyright">
                &copy; {{ date('Y') }} <strong>Footer - Sunshine</strong> â All Rights Reserved
            </span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (clearCacheBtn) {
            clearCacheBtn.addEventListener('click', function(e) {
                ...
                fetch(`{{ Route::has('clear.cache') ? route('clear.cache') : '/public/clear_cache.php' }}`, {
                    method: 'GET',
                    headers: {
