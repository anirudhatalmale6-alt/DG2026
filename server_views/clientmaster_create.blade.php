                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->cor_certificate_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ Route::has('cimsdocmanager.view.client') ? route('cimsdocmanager.view.client',['client_id' => $client->client_id,'document' => 'cor_14_3_certificate']) : '#' }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->income_tax_notice_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ Route::has('cimsdocmanager.view.client') ? route('cimsdocmanager.view.client',['client_id' => $client->client_id,'document' => 'income_tax_registration']) : '#' }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->payroll_notice_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ Route::has('cimsdocmanager.view.client') ? route('cimsdocmanager.view.client',['client_id' => $client->client_id,'document' => 'payroll_registration']) : '#' }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->vat_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ Route::has('cimsdocmanager.view.client') ? route('cimsdocmanager.view.client',['client_id' => $client->client_id,'document' => 'vat_registration']) : '#' }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                            ...
                            <div class="row" id="address-form">
                                <div class="col-md-12">
                                    <div class="form-section-title d-flex justify-content-between align-items-center">
                                        ...
                                        <x-pink-button href="{{ Route::has('cimsaddresses.create') ? route('cimsaddresses.create') : '#' }}" target="_blank">
...
$('#company_name').on('blur', function() {
    ...
    $.ajax({
        url: `{{ route('client.ajax.check-company-name') }}`,
        type: 'POST',
        data: {
            name: name,
            exclude_id: clientId,
...
function generateClientCode(companyName) {
    $.ajax({
        ...
        url: `{{ route('client.ajax.generate-code') }}`,
        type: 'GET',
        data: {
...
function validateCompanyType(regNumber, typeCode, $companyType, $regFeedback, $typeFeedback, $input) {
    $.ajax({
        url: `{{ route('client.ajax.get-company-type') }}`,
        type: 'GET',
...
<script>
  ...
  $('#paye_number').on('keyup', function() {
    ...
    $('#bank_name').on('change', function() {
        ...
        // Fetch bank details
        $.ajax({
            url: `{{ route('client.ajax.bank.get', ['id' => '__bankId__']) }}`.replace('__bankId__', bankId),
            type: 'GET',
            dataType: 'json',
    ...
    $('#person_id').on('change', function() {
        ...
        // Fetch bank details
        $.ajax({
            url: `{{ Route::has('cimspersons.ajax.person.get') ? route('cimspersons.ajax.person.get', ['id' => '__personId__']) : url('cims/persons/ajax/__personId__') }}`.replace('__personId__', personId),
            type: 'GET',
            dataType: 'json',
            success: function(data) {
    ...
    $('#address').on('change', function() {
        ...
        // Fetch bank details
        $.ajax({
            url: `{{ route('client.ajax.address.get', ['id' => '__addressId__']) }}`.replace('__addressId__', addressId),
            type: 'GET',
            dataType: 'json',
            success: function(data) {
...
@include('clientmasternew::clientmaster.bank_details_js')
@include('clientmasternew::clientmaster.address_details_js')
@include('clientmasternew::clientmaster.director_js')
