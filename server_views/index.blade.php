    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade active show" id="AllStatus">
            @forelse($clients as $client)
                @include('clientmasternew::clientmaster._card', ['client' => $client, 'showStatus' => true])
            @empty
        ...
        <div class="tab-pane fade" id="Active">
            @forelse($clients->where('is_active', 1) as $client)
                @include('clientmasternew::clientmaster._card', ['client' => $client, 'showStatus' => false])
            @empty
        ...
        <div class="tab-pane fade" id="Inactive">
            @forelse($clients->where('is_active', 0) as $client)
                @include('clientmasternew::clientmaster._card', ['client' => $client, 'showStatus' => false, 'inactive' => true])
            @empty
        ...
        <div class="tab-pane fade" id="Deleted">
            @forelse($deletedClients ?? [] as $client)
                @include('clientmasternew::clientmaster._deleted_card', ['client' => $client])
            @empty
