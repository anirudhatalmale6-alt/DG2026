        ...
        <table>
            ...
            <tr>
                ...
                <td class="x-payments"> <a href="javascript:void(0)"
                        ...
                        data-modal-size="modal-lg"><span class="p-l-20">{!! runtimeMoneyFormatPDF($bill->sum_payments)
                            !!}</span></a>
                </td>
                @else
            ...
            <tr>
                ...
                <td class="x-balance-due"> <span class="x-due-amount-label">
                        ...
                        <label class="label label-rounded label-danger" id="billing-details-amount-due">{!!
                            runtimeMoneyFormatPDF($bill->invoice_balance) !!}</label>
                        @else
                        <label class="label label-rounded label-success" id="billing-details-amount-due">{!!
                            runtimeMoneyFormatPDF($bill->invoice_balance) !!}</label>
                        @endif
                    </span>
                    <!--pdf-->
