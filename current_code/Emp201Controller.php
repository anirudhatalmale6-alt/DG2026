...
class Emp201Controller extends Controller
{
    ...
    private function getFormData(Request $request): array
    {
        $data = $request->only([
            ...
            'income_tax_number', 'paye_number', 'sdl_number', 'uif_number',
            'title', 'initial', 'first_name', 'surname', 'position',
            'telephone_number', 'mobile_number', 'whatsapp_number', 'home_number', 'email',
            'pay_period', 'financial_year', 'period_combo',
            'paye_liability', 'sdl_liability', 'uif_liability',
            'penalty', 'interest', 'other', 'tax_payable',
        ...
        $numericFields = ['paye_liability', 'sdl_liability', 'uif_liability', 'penalty', 'interest', 'other', 'tax_payable', 'payment_amount', 'balance_outstanding'];
        ...
        // Handle file uploads
        $fileFields = [
            'sars_emp201_return' => 'file_emp201_return',
            'sars_paye_statement' => 'file_emp201_statement',
            'emp201_working_papers' => 'file_working_papers',
            'emp201_pack' => 'file_emp201_pack',
        ];
