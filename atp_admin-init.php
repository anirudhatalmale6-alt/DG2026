<?php
/**
* The Proactive_Admin initiate the theme admin
*/
...
class Proactive_Admin extends Proactive_Base{
    ...
    public function fix_parent_menu() {
		...
		$submenu['pxlart'][0][0] = proactive()->get_name().' '.esc_html__( 'Dashboard', 'proactive' );
