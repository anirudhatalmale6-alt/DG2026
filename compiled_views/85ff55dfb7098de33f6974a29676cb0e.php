...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('page_description', 'Client Master'); ?>" />
    <meta name="format-detection" content="telephone=no">
    <link rel="shortcut icon" type="image/png" href="/public/smartdash/images/favicon.png">

    <title>CIMS | <?php echo $__env->yieldContent('title', 'Client Master'); ?></title>
    ...
    <link href="/public/modules/cimscore/css/cims_master_system_settings.css" rel="stylesheet">
...
<!-- CIMS Header -->
<?php echo $__env->make('cimscore::partials.cims_master_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<!-- CIMS Master Menu -->
<?php echo $__env->make('cimscore::partials.cims_master_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<!-- CIMS Master Footer -->
<?php echo $__env->make('cimscore::partials.cims_master_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /usr/www/users/smartucbmh/application/resources/views/layouts/default.blade.php ENDPATH**/ ?>