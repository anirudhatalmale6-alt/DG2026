    ...
    <div class="cims-header-inner">
        ...
        <div class="cims-header-left">
            <div class="cims-header-brand">
                <img src="<?php echo e(asset('assets/cims_core/atp_cims_logo.jpg')); ?>" alt="SmartDash CIMS" class="cims-header-logo">
        ...
        <div class="cims-header-right">
            ...
            <div class="cims-header-profile">
                <img src="<?php echo e(asset('assets/cims_core/user_profile.jpg')); ?>" alt="User" class="cims-profile-img">
            </div>
        </div>
...
<?php /**PATH /usr/www/users/smartucbmh/application/Modules/CIMSCore/Resources/views/partials/cims_master_header.blade.php ENDPATH**/ ?>