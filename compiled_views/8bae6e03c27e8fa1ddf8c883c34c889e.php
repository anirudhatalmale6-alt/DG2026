<head>
    ...
    <link rel="stylesheet"
        href="/public/vendor/fonts/phosphor-icons/regular/style.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--2025 - TABLER ICONS-->
    <link rel="stylesheet"
        href="/public/vendor/fonts/tabler-icons/tabler-icons.css?v=<?php echo e(config('system.versioning')); ?>">

    <!--2025 - LINEICONS ICONS-->
    <link rel="stylesheet" href="/public/vendor/fonts/lineicons/css/icons.css?v=<?php echo e(config('system.versioning')); ?>">
    ...
    <?php echo $__env->yieldPushContent('layout_header_1'); ?>
    ...
    <script type="text/javascript">
        ...
        NXLANG.invoice_mode = "<?php echo e(cleanLang(__('lang.invoice_mode'))); ?>";
        NXLANG.url_copied_to_clipboard = "<?php echo e(cleanLang(__('lang.url_copied_to_clipboard'))); ?>";
        NXLANG.copied = "<?php echo e(cleanLang(__('lang.copied'))); ?>";
    ...
    <!--module extension point-->
    <?php echo $__env->yieldPushContent('layout_header_2'); ?>
    ...
    <!--module extension point-->
    <?php echo $__env->yieldPushContent('layout_header_3'); ?>
    ...
    <!--module extension point-->
    <?php echo $__env->yieldPushContent('layout_header_4'); ?>
</head><?php /**PATH /usr/www/users/smartucbmh/application/resources/views/layout/header.blade.php ENDPATH**/ ?>