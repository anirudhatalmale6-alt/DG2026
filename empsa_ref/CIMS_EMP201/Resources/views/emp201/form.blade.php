...
<div class="container-fluid">
    ...
    {{-- ============================================
         SARS LOGO HEADER
         ============================================ --}}
    <div class="sars-logo-header" style="justify-content: space-between;">
        <div style="display: flex; align-items: center;">
            <img src="{{ asset('public/images/sars_logo.png') }}" alt="SARS Logo">
            <div>
                <div class="sars-title">Monthly Employer Return</div>
                <div class="sars-subtitle">South African Revenue Service</div>
            </div>
        </div>
        <div style="font-size: 36px; font-weight: 800; color: #0d3d56; letter-spacing: 2px;">EMP 201</div>
    </div>
    ...
    >
        ...
        <div class="card smartdash-form-card">
            ...
            <div class="card-body">
                ...
                {{-- Row 2: Year, Period, Date & Prepared By --}}
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
        ...
        <div class="card smartdash-form-card">
            ...
            <div class="card-body">
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="col-md-2">
                        <div class="mb-3">
                            <label class="form-label">Check Digit</label>
        ...
        <div class="card smartdash-form-card">
            ...
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <label class="form-label fw-bold"><i class="fa fa-receipt text-success"></i> Proof of Payment</label>
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.found) {
                    ...
                    $('#telephone_number').val(data.office_phone || $selected.data('phone_business') || '');
                    $('#mobile_number').val(data.mobile_phone || $selected.data('phone_mobile') || '');
