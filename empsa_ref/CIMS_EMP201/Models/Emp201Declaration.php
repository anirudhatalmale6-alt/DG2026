...
class Emp201Declaration extends Model
{
    ...
    protected $fillable = [
        ...
        // Payment Reference
        'payment_reference', 'check_digit', 'payment_reference_number',
        ...
        // Upload flags
        'file_emp201_return_uploaded', 'file_emp201_statement_uploaded',
        'file_working_papers_uploaded', 'file_emp201_pack_uploaded',
        'file_proof_of_payment_uploaded',
    ...
    public function sarsStatus()
    {
        return $this->belongsTo(SarsStatus::class, 'emp201_status');
    }
