 ...
 * - Display format: d MMMM yyyy (e.g., "21 June 2022") - Human readable
 * - Database format: yyyy-mm-dd (e.g., "2022-06-21") - For processing
 * - Long date: DDD, dd mmm yyyy (e.g., "Monday, 27 January 2026") - For DOB from ID
 *
 * Usage:
...
var SmartDashDates = {
    // SA Date Formats
    formats: {
        display: 'D, j M Y',      // Mon, 21 Jun 2022 (with day of week)
        database: 'Y-m-d',        // 2022-06-21 (for database)
