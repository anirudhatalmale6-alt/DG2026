                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->cor_certificate_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ route('client.document.view', ['clientId' => $client->client_id, 'documentType' => 'cor_14_3_certificate']) }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->income_tax_notice_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ route('client.document.view', ['clientId' => $client->client_id, 'documentType' => 'income_tax_registration']) }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->payroll_notice_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ route('client.document.view', ['clientId' => $client->client_id, 'documentType' => 'payroll_registration']) }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @if(isset($client) && $client->vat_registration_uploaded)
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="mt-1">
                                                        <span class="badge bg-primary sd_background_pink font-18"> <a href="{{ route('client.document.view', ['clientId' => $client->client_id, 'documentType' => 'vat_registration']) }}"  class="text-white" target="_blank"> <i class="fa fa-download"></i> View Certificate </a> </span>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
