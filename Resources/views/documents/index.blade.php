            ...
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex justify-content-between align-items-center"
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <a href="{{ route('docgen.create') }}" class="btn btn-primary btn-sm shadow-sm">
                            <i class="fa fa-plus me-1"></i> Generate New Document
                        </a>
                        <a href="{{ route('docgen.templates') }}" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                <li>
                                    <a class="dropdown-item" href="{{ route('docgen.settings') }}">
                                        <i class="fa fa-sliders-h me-2 text-muted"></i> General Settings
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('docgen.smtp') }}">
                ...
                <div class="card-body">
                    ...
                    {{-- ── Filter Bar ──────────────────────────────────────── --}}
                    <form method="GET" action="{{ route('docgen.index') }}" id="filterForm">
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col-md-3 col-lg-3 d-flex gap-2">
                                ...
                                @if(request('search') || request('status') || request('template_id'))
                                    <a href="{{ route('docgen.index') }}" class="btn btn-sm btn-outline-secondary">
                                ...
                                <tbody>
                                    @foreach($documents as $index => $document)
                                        <tr id="document-row-{{ $document->id }}">
                                            ...
                                            <td>
                                                <a href="{{ route('docgen.show', $document->id) }}" class="text-decoration-none fw-medium">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex gap-1 justify-content-end">
                                                    {{-- View --}}
                                                    <a href="{{ route('docgen.show', $document->id) }}"
                                                    ...
                                                    {{-- Download --}}
                                                    <a href="{{ route('docgen.download', $document->id) }}"
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                @endif
                                <a href="{{ route('docgen.create') }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus me-1"></i> Generate New Document
                                </a>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-email-document').forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            document.getElementById('emailDocumentForm').action = '{{ url("cims/docgen/documents") }}/' + docId + '/email';
    ...
    document.querySelectorAll('.btn-change-status').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            form.method = 'POST';
            form.action = '{{ url("cims/docgen/documents") }}/' + docId + '/status';
    ...
    document.querySelectorAll('.btn-delete-document').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            fetch('{{ url("cims/docgen/documents") }}/' + docId, {
                method: 'DELETE',
                headers: {
