            ...
            <div class="card shadow-sm border-0">
                <div class="card-header d-flex justify-content-between align-items-center"
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <a href="{{ route('docgen.templates.create') }}" class="btn btn-primary btn-sm shadow-sm">
                ...
                <div class="card-body">
                    ...
                    {{-- ── Search / Filter Bar ───────────────────────────────── --}}
                    <form method="GET" action="{{ route('docgen.templates') }}" id="searchForm">
                        <div class="row g-2 mb-4">
                            ...
                            <div class="col-md-4 col-lg-3 d-flex gap-2">
                                ...
                                @if(request('search') || request('category'))
                                    <a href="{{ route('docgen.templates') }}" class="btn btn-sm btn-outline-secondary">
                                        ...
                                        <tr id="template-row-{{ $t->id }}">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex gap-1 justify-content-end">
                                                    {{-- Edit --}}
                                                    <a href="{{ route('docgen.templates.edit', $t->id) }}"
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center">
                                ...
                                @endif
                                <a href="{{ route('docgen.templates.create') }}" class="btn btn-primary btn-sm">
                                    <i class="fa fa-plus me-1"></i> Create Template
                                </a>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.btn-delete-template').forEach(function (btn) {
        btn.addEventListener('click', function (e) {
            ...
            fetch('{{ url("cims/docgen/templates") }}/' + templateId, {
                method: 'DELETE',
                headers: {
