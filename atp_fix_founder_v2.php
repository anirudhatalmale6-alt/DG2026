...
$elementor_data = array(
    ...
    array(
        ...
        'settings' => array(
            'gap' => 'extended',
            'structure' => '20',
            'padding' => array('unit'=>'px','top'=>'80','right'=>'0','bottom'=>'60','left'=>'0','isLinked'=>false),
            'padding_mobile' => array('unit'=>'px','top'=>'40','right'=>'15','bottom'=>'30','left'=>'15','isLinked'=>false),
        ),
        'elements' => array(
            // Left - Photo
            array(
                'id' => 'fn_col1',
                'elType' => 'column',
                'settings' => array('_column_size'=>42,'_inline_size'=>42,'_inline_size_tablet'=>100),
                'elements' => array(
                    array(
                        'id' => 'fn_img1',
                        'elType' => 'widget',
                        ...
                        'settings' => array(
                            'image' => array('url'=>$photo_url,'id'=>$photo_id),
                            'img_size' => 'full',
            ...
            array(
                ...
                'elType' => 'column',
                'settings' => array(
                    '_column_size'=>58,'_inline_size'=>58,'_inline_size_tablet'=>100,
                    'margin' => array('unit'=>'px','top'=>'0','right'=>'0','bottom'=>'0','left'=>'20','isLinked'=>false),
                    'margin_tablet' => array('unit'=>'px','top'=>'30','right'=>'0','bottom'=>'0','left'=>'0','isLinked'=>false),
                ),
                'elements' => array(
                    // Heading
                    array(
                    ...
                    array(
                        ...
                        'settings' => array(
                            ...
                            'title_space_bottom' => array('unit'=>'px','size'=>5),
                        ),
                    ),
                    // Buttons row
                    array(
                        ...
                        'settings' => array(
                            'structure' => '20',
                            'gap' => 'default',
                            'padding' => array('unit'=>'px','top'=>'20','right'=>'0','bottom'=>'0','left'=>'0','isLinked'=>false),
                        ),
                        'elements' => array(
                            array(
                                'id' => 'fn_bc1',
    ...
    // SECTION 2: Dark quote - "We Don't Just Process Numbers"
    array(
        'id' => 'fn_sec2',
        'elType' => 'section',
        'settings' => array(
            ...
            'background_image' => array('url'=>$bg_section,'id'=>''),
            ...
            'gap' => 'no',
            'padding' => array('unit'=>'px','top'=>'100','right'=>'0','bottom'=>'100','left'=>'0','isLinked'=>false),
            'padding_mobile' => array('unit'=>'px','top'=>'60','right'=>'20','bottom'=>'60','left'=>'20','isLinked'=>false),
        ),
        'elements' => array(
            array(
                'id' => 'fn_qc1',
                ...
                'elements' => array(
                    ...
                    array(
                        ...
                        'settings' => array(
                            ...
                            'title_space_bottom' => array('unit'=>'px','size'=>40),
                                ...
                                'elements' => array(
                                    array(
                                        ...
                                        'settings' => array(
                                            ...
                                            'desc' => 'Structured financial processes tailored to your business needs.',
                                            'icon_type' => 'icon',
                                            'pxl_icon' => array('value'=>'flaticon-results','library'=>''),
                                            'title_color' => '#FFFFFF',
                                            'desc_color' => '#B6B6B6',
                                            'icon_color' => '#e65025',
                                            'pxl_animate' => 'wow PXLfadeInUp',
                                ...
                                'elements' => array(
                                    array(
                                        ...
                                        'settings' => array(
                                            ...
                                            'desc' => 'Clear visibility over your numbers, compliance, and growth.',
                                            'icon_type' => 'icon',
                                            'pxl_icon' => array('value'=>'flaticon-seo','library'=>''),
                                            'title_color' => '#FFFFFF',
                                            'desc_color' => '#B6B6B6',
                                            'icon_color' => '#e65025',
                                            'pxl_animate' => 'wow PXLfadeInUp',
                                ...
                                'elements' => array(
                                    array(
                                        ...
                                        'settings' => array(
                                            ...
                                            'desc' => 'Peace of mind that your business is compliant and positioned for growth.',
                                            'icon_type' => 'icon',
                                            'pxl_icon' => array('value'=>'flaticon-technical-s','library'=>''),
                                            'title_color' => '#FFFFFF',
                                            'desc_color' => '#B6B6B6',
                                            'icon_color' => '#e65025',
                                            'pxl_animate' => 'wow PXLfadeInUp',
    ...
    // SECTION 3: Our Approach + Our Commitment
    array(
        'id' => 'fn_sec3',
        'elType' => 'section',
        'settings' => array(
            'gap' => 'extended',
            'structure' => '20',
            'padding' => array('unit'=>'px','top'=>'80','right'=>'0','bottom'=>'40','left'=>'0','isLinked'=>false),
        ),
        'elements' => array(
            // Left - Our Approach
            array(
                'id' => 'fn_s3c1',
                'elType' => 'column',
                'settings' => array('_column_size'=>50,'_inline_size'=>50,'_inline_size_tablet'=>100),
                'elements' => array(
                    array(
                        'id' => 'fn_s3h1',
                        'elType' => 'widget',
            ...
            array(
                ...
                'elements' => array(
                    ...
                    array(
                        ...
                        'widgetType' => 'pxl_text_editor',
                        'settings' => array(
                            'text_ed' => '<p>Whether you are starting a new venture or managing an established business, our commitment remains the same — to deliver professional accounting, taxation, payroll, and compliance services in South Africa that you can trust.</p><p>We look forward to working with you and supporting your business journey.</p>',
                            'text_typography_typography' => 'custom',
                            'text_typography_font_size' => array('unit'=>'px','size'=>17),
                            'text_typography_line_height' => array('unit'=>'em','size'=>1.75),
                            'text_color' => '#555555',
    ...
    array(
        ...
        'settings' => array(
            'background_background' => 'classic',
            'background_color' => '#1A1A1A',
            'background_image' => array('url'=>$bg_section5,'id'=>''),
            'background_size' => 'cover',
            'background_position' => 'center center',
            'background_overlay_background' => 'classic',
                ...
                'elements' => array(
                    array(
                        ...
                        'settings' => array(
                            ...
                            'title_typography_font_size_mobile' => array('unit'=>'px','size'=>26),
                            'title_typography_line_height' => array('unit'=>'em','size'=>1.3),
                            'title_space_bottom' => array('unit'=>'px','size'=>30),
...
echo "Founder page FIXED with correct field names!\n";
